...
func (o *ResourcepoolResourcePoolParameters) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varResourcepoolResourcePoolParametersWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varResourcepoolResourcePoolParameters)
	if err == nil {
