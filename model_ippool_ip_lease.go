...
type IppoolIpLease struct {
	...
	PreferredIpV4Address *string `json:"PreferredIpV4Address,omitempty" validate:"regexp=^$|^([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\\\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\\\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\\\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])$"`
...
// GetDefaultClassId returns the default value "ippool.IpLease" of the ClassId field.
func (o *IppoolIpLease) GetDefaultClassId() interface{} {
	return "ippool.IpLease"
}
...
// GetDefaultObjectType returns the default value "ippool.IpLease" of the ObjectType field.
func (o *IppoolIpLease) GetDefaultObjectType() interface{} {
	return "ippool.IpLease"
}
...
// GetPreferredIpV4Address returns the PreferredIpV4Address field value if set, zero value otherwise.
func (o *IppoolIpLease) GetPreferredIpV4Address() string {
	if o == nil || IsNil(o.PreferredIpV4Address) {
		var ret string
		return ret
	}
	return *o.PreferredIpV4Address
}

// GetPreferredIpV4AddressOk returns a tuple with the PreferredIpV4Address field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IppoolIpLease) GetPreferredIpV4AddressOk() (*string, bool) {
	if o == nil || IsNil(o.PreferredIpV4Address) {
		return nil, false
	}
	return o.PreferredIpV4Address, true
}
...
// SetPreferredIpV4Address gets a reference to the given string and assigns it to the PreferredIpV4Address field.
func (o *IppoolIpLease) SetPreferredIpV4Address(v string) {
	o.PreferredIpV4Address = &v
}

// GetPreferredIpV6Address returns the PreferredIpV6Address field value if set, zero value otherwise.
func (o *IppoolIpLease) GetPreferredIpV6Address() string {
	if o == nil || IsNil(o.PreferredIpV6Address) {
		var ret string
		return ret
	}
	return *o.PreferredIpV6Address
}

// GetPreferredIpV6AddressOk returns a tuple with the PreferredIpV6Address field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IppoolIpLease) GetPreferredIpV6AddressOk() (*string, bool) {
	if o == nil || IsNil(o.PreferredIpV6Address) {
		return nil, false
	}
	return o.PreferredIpV6Address, true
}
...
// SetPreferredIpV6Address gets a reference to the given string and assigns it to the PreferredIpV6Address field.
func (o *IppoolIpLease) SetPreferredIpV6Address(v string) {
	o.PreferredIpV6Address = &v
}
...
func (o IppoolIpLease) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PreferredIpV4Address) {
		toSerialize["PreferredIpV4Address"] = o.PreferredIpV4Address
	}
	if !IsNil(o.PreferredIpV6Address) {
		toSerialize["PreferredIpV6Address"] = o.PreferredIpV6Address
	}
...
func (o *IppoolIpLease) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varIppoolIpLease.PreferredIpV4Address = varIppoolIpLeaseWithoutEmbeddedStruct.PreferredIpV4Address
		varIppoolIpLease.PreferredIpV6Address = varIppoolIpLeaseWithoutEmbeddedStruct.PreferredIpV6Address
		varIppoolIpLease.Reservation = varIppoolIpLeaseWithoutEmbeddedStruct.Reservation
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "PreferredIpV4Address")
		delete(additionalProperties, "PreferredIpV6Address")
