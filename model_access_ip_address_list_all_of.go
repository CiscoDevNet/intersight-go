...
// AccessIpAddressListAllOf struct for AccessIpAddressListAllOf
type AccessIpAddressListAllOf struct {
...
type _AccessIpAddressListAllOf AccessIpAddressListAllOf
...
func (o AccessIpAddressListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *AccessIpAddressListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varAccessIpAddressListAllOf := _AccessIpAddressListAllOf{}

	if err = json.Unmarshal(bytes, &varAccessIpAddressListAllOf); err == nil {
		*o = AccessIpAddressListAllOf(varAccessIpAddressListAllOf)
	}
...
type NullableAccessIpAddressListAllOf struct {
	value *AccessIpAddressListAllOf
	isSet bool
}

func (v NullableAccessIpAddressListAllOf) Get() *AccessIpAddressListAllOf {
	return v.value
}

func (v *NullableAccessIpAddressListAllOf) Set(val *AccessIpAddressListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessIpAddressListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessIpAddressListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessIpAddressListAllOf(val *AccessIpAddressListAllOf) *NullableAccessIpAddressListAllOf {
	return &NullableAccessIpAddressListAllOf{value: val, isSet: true}
}

func (v NullableAccessIpAddressListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessIpAddressListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
