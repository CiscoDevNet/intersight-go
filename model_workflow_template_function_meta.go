...
// checks if the WorkflowTemplateFunctionMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowTemplateFunctionMeta{}

// WorkflowTemplateFunctionMeta The TemplateFunctionMeta object is a key component within the workflow system, designed to encapsulate the metadata and functionality of template functions. #### Purpose   TemplateFunctionMeta serves as the blueprint for defining custom template functions that are supported by the system. #### Key Concepts  - **Documentation and Metadata:** Contains comprehensive descriptions and usage examples, aiding in understanding and leveraging template functions effectively.
...
// GetDefaultClassId returns the default value "workflow.TemplateFunctionMeta" of the ClassId field.
func (o *WorkflowTemplateFunctionMeta) GetDefaultClassId() interface{} {
	return "workflow.TemplateFunctionMeta"
}
...
// GetDefaultObjectType returns the default value "workflow.TemplateFunctionMeta" of the ObjectType field.
func (o *WorkflowTemplateFunctionMeta) GetDefaultObjectType() interface{} {
	return "workflow.TemplateFunctionMeta"
}
...
func (o *WorkflowTemplateFunctionMeta) GetIsGuidedModeSupported() bool {
	if o == nil || IsNil(o.IsGuidedModeSupported) {
		var ret bool
		return ret
	}
...
func (o WorkflowTemplateFunctionMeta) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsGuidedModeSupported) {
...
func (o *WorkflowTemplateFunctionMeta) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowTemplateFunctionMetaWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowTemplateFunctionMeta)
	if err == nil {
