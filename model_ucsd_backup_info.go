...
// UcsdBackupInfo The BackupInfo object provides detailed insights into backup images available for restoration on target endpoint (UCS Director) devices. It captures essential metadata and status information to support recovery operations. #### Purpose The BackupInfo object provides comprehensive visibility into available backup images and real-time status updates on backup progress. It ensures that restoration processes rely on accurate, current data, enabling informed and efficient recovery operations. #### Key Concepts - **Transparency:** Delivers comprehensive metadata about backup images, including status, location, and completion percentage. - **Access Control:** Designed to allow authorized personnel to access backup information securely. - **Relationship Management:** Extends abstract backup information concepts to provide a detailed view of available resources.
...
func (o *UcsdBackupInfo) GetDefaultClassId() interface{} {
...
func (o *UcsdBackupInfo) GetDefaultObjectType() interface{} {
	return "ucsd.BackupInfo"
}
