...
type CapabilitySwitchCapability struct {
	...
	PortsSupporting400gSpeed           []CapabilityPortRange                 `json:"PortsSupporting400gSpeed,omitempty"`
	PortsSupporting40gSpeed            []CapabilityPortRange                 `json:"PortsSupporting40gSpeed,omitempty"`
	PortsSupporting50gSpeed            []CapabilityPortRange                 `json:"PortsSupporting50gSpeed,omitempty"`
...
// GetPortsSupporting400gSpeed returns the PortsSupporting400gSpeed field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CapabilitySwitchCapability) GetPortsSupporting400gSpeed() []CapabilityPortRange {
	if o == nil {
		var ret []CapabilityPortRange
		return ret
	}
	return o.PortsSupporting400gSpeed
}

// GetPortsSupporting400gSpeedOk returns a tuple with the PortsSupporting400gSpeed field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CapabilitySwitchCapability) GetPortsSupporting400gSpeedOk() ([]CapabilityPortRange, bool) {
	if o == nil || IsNil(o.PortsSupporting400gSpeed) {
		return nil, false
	}
	return o.PortsSupporting400gSpeed, true
}
...
// SetPortsSupporting400gSpeed gets a reference to the given []CapabilityPortRange and assigns it to the PortsSupporting400gSpeed field.
func (o *CapabilitySwitchCapability) SetPortsSupporting400gSpeed(v []CapabilityPortRange) {
	o.PortsSupporting400gSpeed = v
}
...
// GetPortsSupporting50gSpeed returns the PortsSupporting50gSpeed field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CapabilitySwitchCapability) GetPortsSupporting50gSpeed() []CapabilityPortRange {
	if o == nil {
		var ret []CapabilityPortRange
		return ret
	}
	return o.PortsSupporting50gSpeed
}

// GetPortsSupporting50gSpeedOk returns a tuple with the PortsSupporting50gSpeed field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CapabilitySwitchCapability) GetPortsSupporting50gSpeedOk() ([]CapabilityPortRange, bool) {
	if o == nil || IsNil(o.PortsSupporting50gSpeed) {
		return nil, false
	}
	return o.PortsSupporting50gSpeed, true
}
...
// SetPortsSupporting50gSpeed gets a reference to the given []CapabilityPortRange and assigns it to the PortsSupporting50gSpeed field.
func (o *CapabilitySwitchCapability) SetPortsSupporting50gSpeed(v []CapabilityPortRange) {
	o.PortsSupporting50gSpeed = v
}
...
func (o CapabilitySwitchCapability) ToMap() (map[string]interface{}, error) {
	...
	if o.PortsSupporting400gSpeed != nil {
		toSerialize["PortsSupporting400gSpeed"] = o.PortsSupporting400gSpeed
	}
	if o.PortsSupporting40gSpeed != nil {
		toSerialize["PortsSupporting40gSpeed"] = o.PortsSupporting40gSpeed
	}
	if o.PortsSupporting50gSpeed != nil {
		toSerialize["PortsSupporting50gSpeed"] = o.PortsSupporting50gSpeed
	}
...
func (o *CapabilitySwitchCapability) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varCapabilitySwitchCapability.PortsSupporting400gSpeed = varCapabilitySwitchCapabilityWithoutEmbeddedStruct.PortsSupporting400gSpeed
		...
		varCapabilitySwitchCapability.PortsSupporting50gSpeed = varCapabilitySwitchCapabilityWithoutEmbeddedStruct.PortsSupporting50gSpeed
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "PortsSupporting400gSpeed")
		delete(additionalProperties, "PortsSupporting40gSpeed")
		delete(additionalProperties, "PortsSupporting50gSpeed")
