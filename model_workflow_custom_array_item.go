...
// checks if the WorkflowCustomArrayItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowCustomArrayItem{}
...
// GetDefaultClassId returns the default value "workflow.CustomArrayItem" of the ClassId field.
func (o *WorkflowCustomArrayItem) GetDefaultClassId() interface{} {
	return "workflow.CustomArrayItem"
}
...
// GetDefaultObjectType returns the default value "workflow.CustomArrayItem" of the ObjectType field.
func (o *WorkflowCustomArrayItem) GetDefaultObjectType() interface{} {
	return "workflow.CustomArrayItem"
}
...
func (o WorkflowCustomArrayItem) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowCustomArrayItem) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowCustomArrayItemWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowCustomArrayItem)
	if err == nil {
