...
// checks if the ApplianceAutoRmaPolicyList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplianceAutoRmaPolicyList{}
...
func (o ApplianceAutoRmaPolicyList) ToMap() (map[string]interface{}, error) {
...
func (o *ApplianceAutoRmaPolicyList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varApplianceAutoRmaPolicyListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varApplianceAutoRmaPolicyList)
	if err == nil {
