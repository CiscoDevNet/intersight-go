...
func (r ApiGetMacpoolIdBlockByMoidRequest) Select_(select_ string) ApiGetMacpoolIdBlockByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetMacpoolIdBlockByMoidRequest) Expand(expand string) ApiGetMacpoolIdBlockByMoidRequest {
	r.expand = &expand
	return r
}
...
func (r ApiGetMacpoolIdBlockByMoidRequest) At(at string) ApiGetMacpoolIdBlockByMoidRequest {
	r.at = &at
	return r
}
...
// Specifies a subset of properties to return.
func (r ApiGetMacpoolLeaseByMoidRequest) Select_(select_ string) ApiGetMacpoolLeaseByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetMacpoolLeaseByMoidRequest) Expand(expand string) ApiGetMacpoolLeaseByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetMacpoolLeaseByMoidRequest) At(at string) ApiGetMacpoolLeaseByMoidRequest {
	r.at = &at
	return r
}
...
// Specifies a subset of properties to return.
func (r ApiGetMacpoolPoolByMoidRequest) Select_(select_ string) ApiGetMacpoolPoolByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetMacpoolPoolByMoidRequest) Expand(expand string) ApiGetMacpoolPoolByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetMacpoolPoolByMoidRequest) At(at string) ApiGetMacpoolPoolByMoidRequest {
	r.at = &at
	return r
}
...
// Specifies a subset of properties to return.
func (r ApiGetMacpoolPoolMemberByMoidRequest) Select_(select_ string) ApiGetMacpoolPoolMemberByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetMacpoolPoolMemberByMoidRequest) Expand(expand string) ApiGetMacpoolPoolMemberByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetMacpoolPoolMemberByMoidRequest) At(at string) ApiGetMacpoolPoolMemberByMoidRequest {
	r.at = &at
	return r
}
...
// Specifies a subset of properties to return.
func (r ApiGetMacpoolReservationByMoidRequest) Select_(select_ string) ApiGetMacpoolReservationByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetMacpoolReservationByMoidRequest) Expand(expand string) ApiGetMacpoolReservationByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetMacpoolReservationByMoidRequest) At(at string) ApiGetMacpoolReservationByMoidRequest {
	r.at = &at
	return r
}
...
// Specifies a subset of properties to return.
func (r ApiGetMacpoolUniverseByMoidRequest) Select_(select_ string) ApiGetMacpoolUniverseByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetMacpoolUniverseByMoidRequest) Expand(expand string) ApiGetMacpoolUniverseByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetMacpoolUniverseByMoidRequest) At(at string) ApiGetMacpoolUniverseByMoidRequest {
	r.at = &at
	return r
}
...
type ApiPatchMacpoolReservationRequest struct {
	ctx                context.Context
	ApiService         *MacpoolApiService
	moid               string
	macpoolReservation *MacpoolReservation
...
// The &#39;macpool.Reservation&#39; resource to update.
func (r ApiPatchMacpoolReservationRequest) MacpoolReservation(macpoolReservation MacpoolReservation) ApiPatchMacpoolReservationRequest {
	r.macpoolReservation = &macpoolReservation
	return r
}

// For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
func (r ApiPatchMacpoolReservationRequest) IfMatch(ifMatch string) ApiPatchMacpoolReservationRequest {
	r.ifMatch = &ifMatch
	return r
}

func (r ApiPatchMacpoolReservationRequest) Execute() (*MacpoolReservation, *http.Response, error) {
	return r.ApiService.PatchMacpoolReservationExecute(r)
}

/*
PatchMacpoolReservation Update a 'macpool.Reservation' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param moid The unique Moid identifier of a resource instance.
	@return ApiPatchMacpoolReservationRequest
*/
func (a *MacpoolApiService) PatchMacpoolReservation(ctx context.Context, moid string) ApiPatchMacpoolReservationRequest {
	return ApiPatchMacpoolReservationRequest{
		ApiService: a,
		ctx:        ctx,
		moid:       moid,
...
//
//	@return MacpoolReservation
func (a *MacpoolApiService) PatchMacpoolReservationExecute(r ApiPatchMacpoolReservationRequest) (*MacpoolReservation, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MacpoolApiService.PatchMacpoolReservation")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateMacpoolReservationRequest struct {
	ctx                context.Context
	ApiService         *MacpoolApiService
	moid               string
	macpoolReservation *MacpoolReservation
...
// The &#39;macpool.Reservation&#39; resource to update.
func (r ApiUpdateMacpoolReservationRequest) MacpoolReservation(macpoolReservation MacpoolReservation) ApiUpdateMacpoolReservationRequest {
	r.macpoolReservation = &macpoolReservation
	return r
}

// For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
func (r ApiUpdateMacpoolReservationRequest) IfMatch(ifMatch string) ApiUpdateMacpoolReservationRequest {
	r.ifMatch = &ifMatch
	return r
}

func (r ApiUpdateMacpoolReservationRequest) Execute() (*MacpoolReservation, *http.Response, error) {
	return r.ApiService.UpdateMacpoolReservationExecute(r)
}

/*
UpdateMacpoolReservation Update a 'macpool.Reservation' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param moid The unique Moid identifier of a resource instance.
	@return ApiUpdateMacpoolReservationRequest
*/
func (a *MacpoolApiService) UpdateMacpoolReservation(ctx context.Context, moid string) ApiUpdateMacpoolReservationRequest {
	return ApiUpdateMacpoolReservationRequest{
		ApiService: a,
		ctx:        ctx,
		moid:       moid,
...
//
//	@return MacpoolReservation
func (a *MacpoolApiService) UpdateMacpoolReservationExecute(r ApiUpdateMacpoolReservationRequest) (*MacpoolReservation, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MacpoolApiService.UpdateMacpoolReservation")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
