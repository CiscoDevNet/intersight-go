...
// HciNode The Node object encapsulates the details of individual nodes within clusters, as reported by Nutanix Prism Central. This provides a structured representation of nodes, including their configuration and operational status. #### Purpose  The Node object provides a detailed view of node configurations.  #### Key Concepts   - **Configuration Details:** Offers insights into node attributes like hypervisor type, model details, host type, and associated objects like disks and VMs. - **Operational Status:** Monitors node health, operational states, and resource utilization. - **Server Linkage:** The PhysicalServer property on the node object provides a link to the actual server, if the server is claimed in Intersight.
type HciNode struct {
	MoBaseMo
