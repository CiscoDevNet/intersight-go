...
func (o *VnicFcIfInventoryList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varVnicFcIfInventoryListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varVnicFcIfInventoryList)
	if err == nil {
