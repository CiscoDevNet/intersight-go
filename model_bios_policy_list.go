...
// checks if the BiosPolicyList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BiosPolicyList{}
...
func NewBiosPolicyList(objectType string) *BiosPolicyList {
	this := BiosPolicyList{}
...
func (o BiosPolicyList) ToMap() (map[string]interface{}, error) {
...
func (o *BiosPolicyList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varBiosPolicyListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varBiosPolicyList)
	if err == nil {
