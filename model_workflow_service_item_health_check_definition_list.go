...
func (o *WorkflowServiceItemHealthCheckDefinitionList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varWorkflowServiceItemHealthCheckDefinitionListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varWorkflowServiceItemHealthCheckDefinitionList)
	if err == nil {
