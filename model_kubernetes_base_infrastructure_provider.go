...
// checks if the KubernetesBaseInfrastructureProvider type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesBaseInfrastructureProvider{}
...
func (o *KubernetesBaseInfrastructureProvider) GetDefaultClassId() interface{} {
...
func (o *KubernetesBaseInfrastructureProvider) GetDefaultObjectType() interface{} {
	return "kubernetes.VirtualMachineInfrastructureProvider"
}
...
func (o *KubernetesBaseInfrastructureProvider) SetNodeGroupNil() {
	o.NodeGroup.Set(nil)
}
...
func (o KubernetesBaseInfrastructureProvider) ToMap() (map[string]interface{}, error) {
...
func (o *KubernetesBaseInfrastructureProvider) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varKubernetesBaseInfrastructureProviderWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varKubernetesBaseInfrastructureProvider)
	if err == nil {
