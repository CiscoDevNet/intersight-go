...
// checks if the AssetNoAuthenticationCredential type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetNoAuthenticationCredential{}
...
func (o AssetNoAuthenticationCredential) ToMap() (map[string]interface{}, error) {
...
func (o *AssetNoAuthenticationCredential) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAssetNoAuthenticationCredentialWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAssetNoAuthenticationCredential)
	if err == nil {
