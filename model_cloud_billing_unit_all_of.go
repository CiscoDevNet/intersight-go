...
// CloudBillingUnitAllOf Definition of the list of properties defined in 'cloud.BillingUnit', excluding properties defined in parent classes.
type CloudBillingUnitAllOf struct {
...
type _CloudBillingUnitAllOf CloudBillingUnitAllOf
...
func (o CloudBillingUnitAllOf) MarshalJSON() ([]byte, error) {
...
func (o *CloudBillingUnitAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCloudBillingUnitAllOf := _CloudBillingUnitAllOf{}

	if err = json.Unmarshal(bytes, &varCloudBillingUnitAllOf); err == nil {
		*o = CloudBillingUnitAllOf(varCloudBillingUnitAllOf)
	}
...
type NullableCloudBillingUnitAllOf struct {
	value *CloudBillingUnitAllOf
	isSet bool
}

func (v NullableCloudBillingUnitAllOf) Get() *CloudBillingUnitAllOf {
	return v.value
}

func (v *NullableCloudBillingUnitAllOf) Set(val *CloudBillingUnitAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudBillingUnitAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudBillingUnitAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudBillingUnitAllOf(val *CloudBillingUnitAllOf) *NullableCloudBillingUnitAllOf {
	return &NullableCloudBillingUnitAllOf{value: val, isSet: true}
}

func (v NullableCloudBillingUnitAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudBillingUnitAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
