...
// StorageHitachiRemoteCopyPairGad The HitachiRemoteCopyPairGad object represents the global-active device pair entity within the Hitachi storage array, focusing on replication management and operations. #### Purpose HitachiRemoteCopyPairGad is designed to manage global-active device pairs, supporting replication operations and monitoring of pair attributes. #### Key Concepts - **Replication Operations:** Manages replication types, LDEV numbers, and status information for global-active device pairs. - **Privilege Sets:** Provides controlled access for managing global-active device pair settings with defined privilege sets. - **Licensing:** Supports operations under specified entitlements, adhering to licensing requirements.
