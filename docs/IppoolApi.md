...
[**CreateIppoolReservation**](IppoolApi.md#CreateIppoolReservation) | **Post** /api/v1/ippool/Reservations | Create a &#39;ippool.Reservation&#39; resource.
...
[**DeleteIppoolReservation**](IppoolApi.md#DeleteIppoolReservation) | **Delete** /api/v1/ippool/Reservations/{Moid} | Delete a &#39;ippool.Reservation&#39; resource.
...
[**GetIppoolReservationByMoid**](IppoolApi.md#GetIppoolReservationByMoid) | **Get** /api/v1/ippool/Reservations/{Moid} | Read a &#39;ippool.Reservation&#39; resource.
[**GetIppoolReservationList**](IppoolApi.md#GetIppoolReservationList) | **Get** /api/v1/ippool/Reservations | Read a &#39;ippool.Reservation&#39; resource.
...
[**PatchIppoolReservation**](IppoolApi.md#PatchIppoolReservation) | **Patch** /api/v1/ippool/Reservations/{Moid} | Update a &#39;ippool.Reservation&#39; resource.
[**UpdateIppoolPool**](IppoolApi.md#UpdateIppoolPool) | **Post** /api/v1/ippool/Pools/{Moid} | Update a &#39;ippool.Pool&#39; resource.
[**UpdateIppoolReservation**](IppoolApi.md#UpdateIppoolReservation) | **Post** /api/v1/ippool/Reservations/{Moid} | Update a &#39;ippool.Reservation&#39; resource.
...
func main() {
	ippoolPool := *openapiclient.NewIppoolPool("ClassId_example", "ObjectType_example") // IppoolPool | The 'ippool.Pool' resource to create.
	...
	resp, r, err := apiClient.IppoolApi.CreateIppoolPool(context.Background()).IppoolPool(ippoolPool).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
	if err != nil {
...
## CreateIppoolReservation

> IppoolReservation CreateIppoolReservation(ctx).IppoolReservation(ippoolReservation).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
...
func main() {
	ippoolReservation := *openapiclient.NewIppoolReservation("ClassId_example", "ObjectType_example") // IppoolReservation | The 'ippool.Reservation' resource to create.
	ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
	ifNoneMatch := "ifNoneMatch_example" // string | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn't happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource's ETag doesn't match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don't have to be identical byte for byte. (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.CreateIppoolReservation(context.Background()).IppoolReservation(ippoolReservation).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `IppoolApi.CreateIppoolReservation``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CreateIppoolReservation`: IppoolReservation
	fmt.Fprintf(os.Stdout, "Response from `IppoolApi.CreateIppoolReservation`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCreateIppoolReservationRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ippoolReservation** | [**IppoolReservation**](IppoolReservation.md) | The &#39;ippool.Reservation&#39; resource to create. | 
 **ifMatch** | **string** | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | 
 **ifNoneMatch** | **string** | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn&#39;t happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource&#39;s ETag doesn&#39;t match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don&#39;t have to be identical byte for byte. | 

### Return type

[**IppoolReservation**](IppoolReservation.md)
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.IppoolApi.DeleteIppoolIpLease(context.Background(), moid).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.IppoolApi.DeleteIppoolPool(context.Background(), moid).Execute()
	if err != nil {
...
## DeleteIppoolReservation

> DeleteIppoolReservation(ctx, moid).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.IppoolApi.DeleteIppoolReservation(context.Background(), moid).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `IppoolApi.DeleteIppoolReservation``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiDeleteIppoolReservationRequest struct via the builder pattern
...
## GetIppoolBlockLeaseByMoid

> IppoolBlockLease GetIppoolBlockLeaseByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.GetIppoolBlockLeaseByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `IppoolApi.GetIppoolBlockLeaseByMoid``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetIppoolBlockLeaseByMoid`: IppoolBlockLease
	fmt.Fprintf(os.Stdout, "Response from `IppoolApi.GetIppoolBlockLeaseByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetIppoolBlockLeaseByMoidRequest struct via the builder pattern
...
## GetIppoolBlockLeaseList

> IppoolBlockLeaseResponse GetIppoolBlockLeaseList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.GetIppoolBlockLeaseList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `IppoolApi.GetIppoolBlockLeaseList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetIppoolBlockLeaseList`: IppoolBlockLeaseResponse
	fmt.Fprintf(os.Stdout, "Response from `IppoolApi.GetIppoolBlockLeaseList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetIppoolBlockLeaseListRequest struct via the builder pattern
...
> IppoolIpLease GetIppoolIpLeaseByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.GetIppoolIpLeaseByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.GetIppoolIpLeaseList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
...
> IppoolPool GetIppoolPoolByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.GetIppoolPoolByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.GetIppoolPoolList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
...
> IppoolPoolMember GetIppoolPoolMemberByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.GetIppoolPoolMemberByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.GetIppoolPoolMemberList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
...
## GetIppoolReservationByMoid

> IppoolReservation GetIppoolReservationByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.GetIppoolReservationByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `IppoolApi.GetIppoolReservationByMoid``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetIppoolReservationByMoid`: IppoolReservation
	fmt.Fprintf(os.Stdout, "Response from `IppoolApi.GetIppoolReservationByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetIppoolReservationByMoidRequest struct via the builder pattern
...
## GetIppoolReservationList

> IppoolReservationResponse GetIppoolReservationList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.GetIppoolReservationList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `IppoolApi.GetIppoolReservationList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetIppoolReservationList`: IppoolReservationResponse
	fmt.Fprintf(os.Stdout, "Response from `IppoolApi.GetIppoolReservationList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetIppoolReservationListRequest struct via the builder pattern
...
[**IppoolReservationResponse**](IppoolReservationResponse.md)
...
> IppoolShadowBlock GetIppoolShadowBlockByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.GetIppoolShadowBlockByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.GetIppoolShadowBlockList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
...
> IppoolShadowPool GetIppoolShadowPoolByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.GetIppoolShadowPoolByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.GetIppoolShadowPoolList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
...
> IppoolUniverse GetIppoolUniverseByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.GetIppoolUniverseByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.GetIppoolUniverseList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
...
func main() {
	moid := "moid_example" // string | The unique Moid identifier of a resource instance.
	ippoolPool := *openapiclient.NewIppoolPool("ClassId_example", "ObjectType_example") // IppoolPool | The 'ippool.Pool' resource to update.
	ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.PatchIppoolPool(context.Background(), moid).IppoolPool(ippoolPool).IfMatch(ifMatch).Execute()
	if err != nil {
...
## PatchIppoolReservation

> IppoolReservation PatchIppoolReservation(ctx, moid).IppoolReservation(ippoolReservation).IfMatch(ifMatch).Execute()
...
func main() {
	moid := "moid_example" // string | The unique Moid identifier of a resource instance.
	ippoolReservation := *openapiclient.NewIppoolReservation("ClassId_example", "ObjectType_example") // IppoolReservation | The 'ippool.Reservation' resource to update.
	ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.PatchIppoolReservation(context.Background(), moid).IppoolReservation(ippoolReservation).IfMatch(ifMatch).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `IppoolApi.PatchIppoolReservation``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchIppoolReservation`: IppoolReservation
	fmt.Fprintf(os.Stdout, "Response from `IppoolApi.PatchIppoolReservation`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchIppoolReservationRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **ippoolReservation** | [**IppoolReservation**](IppoolReservation.md) | The &#39;ippool.Reservation&#39; resource to update. | 
 **ifMatch** | **string** | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | 
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.UpdateIppoolPool(context.Background(), moid).IppoolPool(ippoolPool).IfMatch(ifMatch).Execute()
	if err != nil {
...
## UpdateIppoolReservation

> IppoolReservation UpdateIppoolReservation(ctx, moid).IppoolReservation(ippoolReservation).IfMatch(ifMatch).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IppoolApi.UpdateIppoolReservation(context.Background(), moid).IppoolReservation(ippoolReservation).IfMatch(ifMatch).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `IppoolApi.UpdateIppoolReservation``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `UpdateIppoolReservation`: IppoolReservation
	fmt.Fprintf(os.Stdout, "Response from `IppoolApi.UpdateIppoolReservation`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateIppoolReservationRequest struct via the builder pattern
