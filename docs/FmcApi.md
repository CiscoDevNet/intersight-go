...
------------- | ------------- | -------------
[**GetFmcDeviceByMoid**](FmcApi.md#GetFmcDeviceByMoid) | **Get** /api/v1/fmc/Devices/{Moid} | Read a &#39;fmc.Device&#39; resource.
[**GetFmcDeviceHaPairByMoid**](FmcApi.md#GetFmcDeviceHaPairByMoid) | **Get** /api/v1/fmc/DeviceHaPairs/{Moid} | Read a &#39;fmc.DeviceHaPair&#39; resource.
[**GetFmcDeviceHaPairList**](FmcApi.md#GetFmcDeviceHaPairList) | **Get** /api/v1/fmc/DeviceHaPairs | Read a &#39;fmc.DeviceHaPair&#39; resource.
[**GetFmcDeviceList**](FmcApi.md#GetFmcDeviceList) | **Get** /api/v1/fmc/Devices | Read a &#39;fmc.Device&#39; resource.
[**GetFmcDomainByMoid**](FmcApi.md#GetFmcDomainByMoid) | **Get** /api/v1/fmc/Domains/{Moid} | Read a &#39;fmc.Domain&#39; resource.
[**GetFmcDomainList**](FmcApi.md#GetFmcDomainList) | **Get** /api/v1/fmc/Domains | Read a &#39;fmc.Domain&#39; resource.
[**GetFmcPhysicalInterfaceByMoid**](FmcApi.md#GetFmcPhysicalInterfaceByMoid) | **Get** /api/v1/fmc/PhysicalInterfaces/{Moid} | Read a &#39;fmc.PhysicalInterface&#39; resource.
[**GetFmcPhysicalInterfaceList**](FmcApi.md#GetFmcPhysicalInterfaceList) | **Get** /api/v1/fmc/PhysicalInterfaces | Read a &#39;fmc.PhysicalInterface&#39; resource.



## GetFmcDeviceByMoid

> FmcDevice GetFmcDeviceByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	resp, r, err := apiClient.FmcApi.GetFmcDeviceByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
> FmcDeviceHaPair GetFmcDeviceHaPairByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.FmcApi.GetFmcDeviceHaPairByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
[**FmcDeviceHaPair**](FmcDeviceHaPair.md)
...
## GetFmcDeviceHaPairList

> FmcDeviceHaPairResponse GetFmcDeviceHaPairList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
[**FmcDeviceHaPairResponse**](FmcDeviceHaPairResponse.md)
...
> FmcDeviceResponse GetFmcDeviceList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
[**FmcDeviceResponse**](FmcDeviceResponse.md)
...
> FmcDomain GetFmcDomainByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.FmcApi.GetFmcDomainByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
> FmcDomainResponse GetFmcDomainList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
[**FmcDomainResponse**](FmcDomainResponse.md)
...
> FmcPhysicalInterface GetFmcPhysicalInterfaceByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.FmcApi.GetFmcPhysicalInterfaceByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
[**FmcPhysicalInterface**](FmcPhysicalInterface.md)
...
## GetFmcPhysicalInterfaceList

> FmcPhysicalInterfaceResponse GetFmcPhysicalInterfaceList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
[**FmcPhysicalInterfaceResponse**](FmcPhysicalInterfaceResponse.md)
