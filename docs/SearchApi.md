...
> SearchSearchItem GetSearchSearchItemByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.SearchApi.GetSearchSearchItemByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
> SearchTagItem GetSearchTagItemByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.SearchApi.GetSearchTagItemByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
