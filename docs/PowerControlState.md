...
**PowerRebalancing** | Pointer to **string** | The status of power rebalancing mode of the chassis. If enabled, this mode allows the system to dynamically reallocate the power between servers depending on their power usage. * &#x60;Enabled&#x60; - The power group is administratively enabled. * &#x60;Disabled&#x60; - The power group is administratively disabled. | [optional] [readonly] [default to "Enabled"]
