...
[**GetIpmioverlanPolicyInventoryByMoid**](IpmioverlanApi.md#GetIpmioverlanPolicyInventoryByMoid) | **Get** /api/v1/ipmioverlan/PolicyInventories/{Moid} | Read a &#39;ipmioverlan.PolicyInventory&#39; resource.
[**GetIpmioverlanPolicyInventoryList**](IpmioverlanApi.md#GetIpmioverlanPolicyInventoryList) | **Get** /api/v1/ipmioverlan/PolicyInventories | Read a &#39;ipmioverlan.PolicyInventory&#39; resource.
...
func main() {
	...
	resp, r, err := apiClient.IpmioverlanApi.CreateIpmioverlanPolicy(context.Background()).IpmioverlanPolicy(ipmioverlanPolicy).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.IpmioverlanApi.DeleteIpmioverlanPolicy(context.Background(), moid).Execute()
	if err != nil {
...
> IpmioverlanPolicy GetIpmioverlanPolicyByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IpmioverlanApi.GetIpmioverlanPolicyByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
> IpmioverlanPolicyInventory GetIpmioverlanPolicyInventoryByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()

Read a 'ipmioverlan.PolicyInventory' resource.
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IpmioverlanApi.GetIpmioverlanPolicyInventoryByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `IpmioverlanApi.GetIpmioverlanPolicyInventoryByMoid``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetIpmioverlanPolicyInventoryByMoid`: IpmioverlanPolicyInventory
	fmt.Fprintf(os.Stdout, "Response from `IpmioverlanApi.GetIpmioverlanPolicyInventoryByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetIpmioverlanPolicyInventoryByMoidRequest struct via the builder pattern
...
[**IpmioverlanPolicyInventory**](IpmioverlanPolicyInventory.md)
...
## GetIpmioverlanPolicyInventoryList

> IpmioverlanPolicyInventoryResponse GetIpmioverlanPolicyInventoryList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IpmioverlanApi.GetIpmioverlanPolicyInventoryList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `IpmioverlanApi.GetIpmioverlanPolicyInventoryList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetIpmioverlanPolicyInventoryList`: IpmioverlanPolicyInventoryResponse
	fmt.Fprintf(os.Stdout, "Response from `IpmioverlanApi.GetIpmioverlanPolicyInventoryList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetIpmioverlanPolicyInventoryListRequest struct via the builder pattern
...
[**IpmioverlanPolicyInventoryResponse**](IpmioverlanPolicyInventoryResponse.md)
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IpmioverlanApi.GetIpmioverlanPolicyList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IpmioverlanApi.PatchIpmioverlanPolicy(context.Background(), moid).IpmioverlanPolicy(ipmioverlanPolicy).IfMatch(ifMatch).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IpmioverlanApi.UpdateIpmioverlanPolicy(context.Background(), moid).IpmioverlanPolicy(ipmioverlanPolicy).IfMatch(ifMatch).Execute()
	if err != nil {
