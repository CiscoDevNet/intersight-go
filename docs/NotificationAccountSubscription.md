...
**FilterRefs** | Pointer to [**[]MoBaseMoRelationship**](MoBaseMoRelationship.md) | An array of relationships to moBaseMo resources. | [optional] [readonly] 
...
`func (o *NotificationAccountSubscription) GetFilterRefs() []MoBaseMoRelationship`

GetFilterRefs returns the FilterRefs field if non-nil, zero value otherwise.

### GetFilterRefsOk

`func (o *NotificationAccountSubscription) GetFilterRefsOk() (*[]MoBaseMoRelationship, bool)`
...
`func (o *NotificationAccountSubscription) SetFilterRefs(v []MoBaseMoRelationship)`

SetFilterRefs sets FilterRefs field to given value.

### HasFilterRefs

`func (o *NotificationAccountSubscription) HasFilterRefs() bool`

HasFilterRefs returns a boolean if a field has been set.

### SetFilterRefsNil

`func (o *NotificationAccountSubscription) SetFilterRefsNil(b bool)`

 SetFilterRefsNil sets the value for FilterRefs to be an explicit nil

### UnsetFilterRefs
`func (o *NotificationAccountSubscription) UnsetFilterRefs()`
