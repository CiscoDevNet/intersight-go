...
------------- | ------------- | -------------
[**CreateAssetClaimToken**](AssetApi.md#CreateAssetClaimToken) | **Post** /api/v1/asset/ClaimTokens | Create a &#39;asset.ClaimToken&#39; resource.
...
[**CreateAssetGeoLocation**](AssetApi.md#CreateAssetGeoLocation) | **Post** /api/v1/asset/GeoLocations | Create a &#39;asset.GeoLocation&#39; resource.
[**CreateAssetPreClaim**](AssetApi.md#CreateAssetPreClaim) | **Post** /api/v1/asset/PreClaims | Create a &#39;asset.PreClaim&#39; resource.
[**CreateAssetTarget**](AssetApi.md#CreateAssetTarget) | **Post** /api/v1/asset/Targets | Create a &#39;asset.Target&#39; resource.
[**DeleteAssetClaimToken**](AssetApi.md#DeleteAssetClaimToken) | **Delete** /api/v1/asset/ClaimTokens/{Moid} | Delete a &#39;asset.ClaimToken&#39; resource.
...
[**DeleteAssetGeoLocation**](AssetApi.md#DeleteAssetGeoLocation) | **Delete** /api/v1/asset/GeoLocations/{Moid} | Delete a &#39;asset.GeoLocation&#39; resource.
[**DeleteAssetTarget**](AssetApi.md#DeleteAssetTarget) | **Delete** /api/v1/asset/Targets/{Moid} | Delete a &#39;asset.Target&#39; resource.
[**GetAssetClaimTokenByMoid**](AssetApi.md#GetAssetClaimTokenByMoid) | **Get** /api/v1/asset/ClaimTokens/{Moid} | Read a &#39;asset.ClaimToken&#39; resource.
[**GetAssetClaimTokenList**](AssetApi.md#GetAssetClaimTokenList) | **Get** /api/v1/asset/ClaimTokens | Read a &#39;asset.ClaimToken&#39; resource.
...
[**GetAssetGeoLocationByMoid**](AssetApi.md#GetAssetGeoLocationByMoid) | **Get** /api/v1/asset/GeoLocations/{Moid} | Read a &#39;asset.GeoLocation&#39; resource.
[**GetAssetGeoLocationList**](AssetApi.md#GetAssetGeoLocationList) | **Get** /api/v1/asset/GeoLocations | Read a &#39;asset.GeoLocation&#39; resource.
...
[**PatchAssetGeoLocation**](AssetApi.md#PatchAssetGeoLocation) | **Patch** /api/v1/asset/GeoLocations/{Moid} | Update a &#39;asset.GeoLocation&#39; resource.
[**PatchAssetPreClaim**](AssetApi.md#PatchAssetPreClaim) | **Patch** /api/v1/asset/PreClaims/{Moid} | Update a &#39;asset.PreClaim&#39; resource.
...
[**UpdateAssetGeoLocation**](AssetApi.md#UpdateAssetGeoLocation) | **Post** /api/v1/asset/GeoLocations/{Moid} | Update a &#39;asset.GeoLocation&#39; resource.
[**UpdateAssetPreClaim**](AssetApi.md#UpdateAssetPreClaim) | **Post** /api/v1/asset/PreClaims/{Moid} | Update a &#39;asset.PreClaim&#39; resource.
[**UpdateAssetTarget**](AssetApi.md#UpdateAssetTarget) | **Post** /api/v1/asset/Targets/{Moid} | Update a &#39;asset.Target&#39; resource.



## CreateAssetClaimToken

> AssetClaimToken CreateAssetClaimToken(ctx).AssetClaimToken(assetClaimToken).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()

Create a 'asset.ClaimToken' resource.
...
func main() {
	assetClaimToken := *openapiclient.NewAssetClaimToken("ClassId_example", "ObjectType_example") // AssetClaimToken | The 'asset.ClaimToken' resource to create.
	...
	resp, r, err := apiClient.AssetApi.CreateAssetClaimToken(context.Background()).AssetClaimToken(assetClaimToken).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AssetApi.CreateAssetClaimToken``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CreateAssetClaimToken`: AssetClaimToken
	fmt.Fprintf(os.Stdout, "Response from `AssetApi.CreateAssetClaimToken`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCreateAssetClaimTokenRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **assetClaimToken** | [**AssetClaimToken**](AssetClaimToken.md) | The &#39;asset.ClaimToken&#39; resource to create. | 
 **ifMatch** | **string** | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | 
 **ifNoneMatch** | **string** | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn&#39;t happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource&#39;s ETag doesn&#39;t match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don&#39;t have to be identical byte for byte. | 

### Return type

[**AssetClaimToken**](AssetClaimToken.md)
...
## CreateAssetDeviceContractNotification

> AssetDeviceContractNotification CreateAssetDeviceContractNotification(ctx).AssetDeviceContractNotification(assetDeviceContractNotification).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **assetDeviceContractNotification** | [**AssetDeviceContractNotification**](AssetDeviceContractNotification.md) | The &#39;asset.DeviceContractNotification&#39; resource to create. | 
 **ifMatch** | **string** | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | 
 **ifNoneMatch** | **string** | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn&#39;t happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource&#39;s ETag doesn&#39;t match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don&#39;t have to be identical byte for byte. | 

### Return type

[**AssetDeviceContractNotification**](AssetDeviceContractNotification.md)
...
## CreateAssetGeoLocation

> AssetGeoLocation CreateAssetGeoLocation(ctx).AssetGeoLocation(assetGeoLocation).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()

Create a 'asset.GeoLocation' resource.
...
func main() {
	assetGeoLocation := *openapiclient.NewAssetGeoLocation("ClassId_example", "ObjectType_example") // AssetGeoLocation | The 'asset.GeoLocation' resource to create.
	ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
	ifNoneMatch := "ifNoneMatch_example" // string | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn't happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource's ETag doesn't match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don't have to be identical byte for byte. (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.CreateAssetGeoLocation(context.Background()).AssetGeoLocation(assetGeoLocation).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AssetApi.CreateAssetGeoLocation``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CreateAssetGeoLocation`: AssetGeoLocation
	fmt.Fprintf(os.Stdout, "Response from `AssetApi.CreateAssetGeoLocation`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCreateAssetGeoLocationRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **assetGeoLocation** | [**AssetGeoLocation**](AssetGeoLocation.md) | The &#39;asset.GeoLocation&#39; resource to create. | 
 **ifMatch** | **string** | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | 
 **ifNoneMatch** | **string** | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn&#39;t happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource&#39;s ETag doesn&#39;t match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don&#39;t have to be identical byte for byte. | 

### Return type

[**AssetGeoLocation**](AssetGeoLocation.md)
...
> AssetPreClaim CreateAssetPreClaim(ctx).AssetPreClaim(assetPreClaim).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()

Create a 'asset.PreClaim' resource.
...
func main() {
	assetPreClaim := *openapiclient.NewAssetPreClaim("ClassId_example", "ObjectType_example") // AssetPreClaim | The 'asset.PreClaim' resource to create.
	ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
	ifNoneMatch := "ifNoneMatch_example" // string | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn't happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource's ETag doesn't match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don't have to be identical byte for byte. (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.CreateAssetPreClaim(context.Background()).AssetPreClaim(assetPreClaim).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AssetApi.CreateAssetPreClaim``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CreateAssetPreClaim`: AssetPreClaim
	fmt.Fprintf(os.Stdout, "Response from `AssetApi.CreateAssetPreClaim`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCreateAssetPreClaimRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **assetPreClaim** | [**AssetPreClaim**](AssetPreClaim.md) | The &#39;asset.PreClaim&#39; resource to create. | 
 **ifMatch** | **string** | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | 
 **ifNoneMatch** | **string** | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn&#39;t happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource&#39;s ETag doesn&#39;t match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don&#39;t have to be identical byte for byte. | 

### Return type

[**AssetPreClaim**](AssetPreClaim.md)
...
## DeleteAssetClaimToken

> DeleteAssetClaimToken(ctx, moid).Execute()

Delete a 'asset.ClaimToken' resource.
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.AssetApi.DeleteAssetClaimToken(context.Background(), moid).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AssetApi.DeleteAssetClaimToken``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiDeleteAssetClaimTokenRequest struct via the builder pattern
...
## DeleteAssetGeoLocation

> DeleteAssetGeoLocation(ctx, moid).Execute()

Delete a 'asset.GeoLocation' resource.
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.AssetApi.DeleteAssetGeoLocation(context.Background(), moid).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AssetApi.DeleteAssetGeoLocation``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiDeleteAssetGeoLocationRequest struct via the builder pattern
...
> AssetClaimToken GetAssetClaimTokenByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()

Read a 'asset.ClaimToken' resource.
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.GetAssetClaimTokenByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AssetApi.GetAssetClaimTokenByMoid``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetAssetClaimTokenByMoid`: AssetClaimToken
	fmt.Fprintf(os.Stdout, "Response from `AssetApi.GetAssetClaimTokenByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetAssetClaimTokenByMoidRequest struct via the builder pattern
...
## GetAssetClaimTokenList

> AssetClaimTokenResponse GetAssetClaimTokenList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.GetAssetClaimTokenList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AssetApi.GetAssetClaimTokenList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetAssetClaimTokenList`: AssetClaimTokenResponse
	fmt.Fprintf(os.Stdout, "Response from `AssetApi.GetAssetClaimTokenList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetAssetClaimTokenListRequest struct via the builder pattern
...
[**AssetClaimTokenResponse**](AssetClaimTokenResponse.md)
...
> AssetClusterMember GetAssetClusterMemberByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.GetAssetClusterMemberByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
> AssetDeployment GetAssetDeploymentByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.GetAssetDeploymentByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
> AssetDeploymentDevice GetAssetDeploymentDeviceByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.GetAssetDeploymentDeviceByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
> AssetDeviceConfiguration GetAssetDeviceConfigurationByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.GetAssetDeviceConfigurationByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
> AssetDeviceConnectorManager GetAssetDeviceConnectorManagerByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.GetAssetDeviceConnectorManagerByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
> AssetDeviceContractInformation GetAssetDeviceContractInformationByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.GetAssetDeviceContractInformationByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
> AssetDeviceRegistration GetAssetDeviceRegistrationByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.GetAssetDeviceRegistrationByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
> AssetGeoLocation GetAssetGeoLocationByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()

Read a 'asset.GeoLocation' resource.
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.GetAssetGeoLocationByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AssetApi.GetAssetGeoLocationByMoid``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetAssetGeoLocationByMoid`: AssetGeoLocation
	fmt.Fprintf(os.Stdout, "Response from `AssetApi.GetAssetGeoLocationByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetAssetGeoLocationByMoidRequest struct via the builder pattern
...
## GetAssetGeoLocationList

> AssetGeoLocationResponse GetAssetGeoLocationList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.GetAssetGeoLocationList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AssetApi.GetAssetGeoLocationList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetAssetGeoLocationList`: AssetGeoLocationResponse
	fmt.Fprintf(os.Stdout, "Response from `AssetApi.GetAssetGeoLocationList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetAssetGeoLocationListRequest struct via the builder pattern
...
[**AssetGeoLocationResponse**](AssetGeoLocationResponse.md)
...
> AssetSubscriptionAccount GetAssetSubscriptionAccountByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.GetAssetSubscriptionAccountByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
> AssetSubscription GetAssetSubscriptionByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.GetAssetSubscriptionByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
> AssetSubscriptionDeviceContractInformation GetAssetSubscriptionDeviceContractInformationByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.GetAssetSubscriptionDeviceContractInformationByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
> AssetTarget GetAssetTargetByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.GetAssetTargetByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
## PatchAssetGeoLocation

> AssetGeoLocation PatchAssetGeoLocation(ctx, moid).AssetGeoLocation(assetGeoLocation).IfMatch(ifMatch).Execute()

Update a 'asset.GeoLocation' resource.
...
func main() {
	moid := "moid_example" // string | The unique Moid identifier of a resource instance.
	assetGeoLocation := *openapiclient.NewAssetGeoLocation("ClassId_example", "ObjectType_example") // AssetGeoLocation | The 'asset.GeoLocation' resource to update.
	ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.PatchAssetGeoLocation(context.Background(), moid).AssetGeoLocation(assetGeoLocation).IfMatch(ifMatch).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AssetApi.PatchAssetGeoLocation``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchAssetGeoLocation`: AssetGeoLocation
	fmt.Fprintf(os.Stdout, "Response from `AssetApi.PatchAssetGeoLocation`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchAssetGeoLocationRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **assetGeoLocation** | [**AssetGeoLocation**](AssetGeoLocation.md) | The &#39;asset.GeoLocation&#39; resource to update. | 
 **ifMatch** | **string** | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | 
...
> AssetPreClaim PatchAssetPreClaim(ctx, moid).AssetPreClaim(assetPreClaim).IfMatch(ifMatch).Execute()

Update a 'asset.PreClaim' resource.
...
func main() {
	moid := "moid_example" // string | The unique Moid identifier of a resource instance.
	assetPreClaim := *openapiclient.NewAssetPreClaim("ClassId_example", "ObjectType_example") // AssetPreClaim | The 'asset.PreClaim' resource to update.
	ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.PatchAssetPreClaim(context.Background(), moid).AssetPreClaim(assetPreClaim).IfMatch(ifMatch).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AssetApi.PatchAssetPreClaim``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchAssetPreClaim`: AssetPreClaim
	fmt.Fprintf(os.Stdout, "Response from `AssetApi.PatchAssetPreClaim`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchAssetPreClaimRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **assetPreClaim** | [**AssetPreClaim**](AssetPreClaim.md) | The &#39;asset.PreClaim&#39; resource to update. | 
 **ifMatch** | **string** | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | 
...
## UpdateAssetGeoLocation

> AssetGeoLocation UpdateAssetGeoLocation(ctx, moid).AssetGeoLocation(assetGeoLocation).IfMatch(ifMatch).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.UpdateAssetGeoLocation(context.Background(), moid).AssetGeoLocation(assetGeoLocation).IfMatch(ifMatch).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AssetApi.UpdateAssetGeoLocation``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `UpdateAssetGeoLocation`: AssetGeoLocation
	fmt.Fprintf(os.Stdout, "Response from `AssetApi.UpdateAssetGeoLocation`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateAssetGeoLocationRequest struct via the builder pattern
...
> AssetPreClaim UpdateAssetPreClaim(ctx, moid).AssetPreClaim(assetPreClaim).IfMatch(ifMatch).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AssetApi.UpdateAssetPreClaim(context.Background(), moid).AssetPreClaim(assetPreClaim).IfMatch(ifMatch).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AssetApi.UpdateAssetPreClaim``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `UpdateAssetPreClaim`: AssetPreClaim
	fmt.Fprintf(os.Stdout, "Response from `AssetApi.UpdateAssetPreClaim`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateAssetPreClaimRequest struct via the builder pattern
