...
**ClaimedTime** | Pointer to **time.Time** | The date at which the target was claimed to this account. For pre-provisioned targets this is the time at which the claim was completed. | [optional] [readonly] 
...
`func (o *AssetTarget) GetClaimedTime() time.Time`

GetClaimedTime returns the ClaimedTime field if non-nil, zero value otherwise.

### GetClaimedTimeOk

`func (o *AssetTarget) GetClaimedTimeOk() (*time.Time, bool)`
...
`func (o *AssetTarget) SetClaimedTime(v time.Time)`

SetClaimedTime sets ClaimedTime field to given value.

### HasClaimedTime

`func (o *AssetTarget) HasClaimedTime() bool`
