...
[**GetMarketplaceCatalogByMoid**](MarketplaceApi.md#GetMarketplaceCatalogByMoid) | **Get** /api/v1/marketplace/Catalogs/{Moid} | Read a &#39;marketplace.Catalog&#39; resource.
[**GetMarketplaceCatalogList**](MarketplaceApi.md#GetMarketplaceCatalogList) | **Get** /api/v1/marketplace/Catalogs | Read a &#39;marketplace.Catalog&#39; resource.
...
## GetMarketplaceCatalogByMoid

> MarketplaceCatalog GetMarketplaceCatalogByMoid(ctx, moid).Execute()

Read a 'marketplace.Catalog' resource.
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.MarketplaceApi.GetMarketplaceCatalogByMoid(context.Background(), moid).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `MarketplaceApi.GetMarketplaceCatalogByMoid``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetMarketplaceCatalogByMoid`: MarketplaceCatalog
	fmt.Fprintf(os.Stdout, "Response from `MarketplaceApi.GetMarketplaceCatalogByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetMarketplaceCatalogByMoidRequest struct via the builder pattern
...
[**MarketplaceCatalog**](MarketplaceCatalog.md)
...
## GetMarketplaceCatalogList

> MarketplaceCatalogResponse GetMarketplaceCatalogList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.MarketplaceApi.GetMarketplaceCatalogList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `MarketplaceApi.GetMarketplaceCatalogList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetMarketplaceCatalogList`: MarketplaceCatalogResponse
	fmt.Fprintf(os.Stdout, "Response from `MarketplaceApi.GetMarketplaceCatalogList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetMarketplaceCatalogListRequest struct via the builder pattern
...
[**MarketplaceCatalogResponse**](MarketplaceCatalogResponse.md)
