...
[**GetSmtpPolicyInventoryByMoid**](SmtpApi.md#GetSmtpPolicyInventoryByMoid) | **Get** /api/v1/smtp/PolicyInventories/{Moid} | Read a &#39;smtp.PolicyInventory&#39; resource.
[**GetSmtpPolicyInventoryList**](SmtpApi.md#GetSmtpPolicyInventoryList) | **Get** /api/v1/smtp/PolicyInventories | Read a &#39;smtp.PolicyInventory&#39; resource.
...
> SmtpPolicy GetSmtpPolicyByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.SmtpApi.GetSmtpPolicyByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
## GetSmtpPolicyInventoryByMoid

> SmtpPolicyInventory GetSmtpPolicyInventoryByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()

Read a 'smtp.PolicyInventory' resource.
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.SmtpApi.GetSmtpPolicyInventoryByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `SmtpApi.GetSmtpPolicyInventoryByMoid``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetSmtpPolicyInventoryByMoid`: SmtpPolicyInventory
	fmt.Fprintf(os.Stdout, "Response from `SmtpApi.GetSmtpPolicyInventoryByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSmtpPolicyInventoryByMoidRequest struct via the builder pattern
...
[**SmtpPolicyInventory**](SmtpPolicyInventory.md)
...
## GetSmtpPolicyInventoryList

> SmtpPolicyInventoryResponse GetSmtpPolicyInventoryList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.SmtpApi.GetSmtpPolicyInventoryList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `SmtpApi.GetSmtpPolicyInventoryList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetSmtpPolicyInventoryList`: SmtpPolicyInventoryResponse
	fmt.Fprintf(os.Stdout, "Response from `SmtpApi.GetSmtpPolicyInventoryList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSmtpPolicyInventoryListRequest struct via the builder pattern
...
[**SmtpPolicyInventoryResponse**](SmtpPolicyInventoryResponse.md)
...
> SmtpPolicyTest GetSmtpPolicyTestByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.SmtpApi.GetSmtpPolicyTestByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
