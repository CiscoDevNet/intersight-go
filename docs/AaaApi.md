...
func main() {
	...
	resp, r, err := apiClient.AaaApi.CreateAaaRetentionPolicy(context.Background()).AaaRetentionPolicy(aaaRetentionPolicy).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
	if err != nil {
...
> AaaAuditRecord GetAaaAuditRecordByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AaaApi.GetAaaAuditRecordByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AaaApi.GetAaaAuditRecordList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
...
> AaaRetentionConfig GetAaaRetentionConfigByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AaaApi.GetAaaRetentionConfigByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AaaApi.GetAaaRetentionConfigList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
...
Other parameters are passed through a pointer to a apiGetAaaRetentionConfigListRequest struct via the builder pattern
...
> AaaRetentionPolicy GetAaaRetentionPolicyByMoid(ctx, moid).Select_(select_).Expand(expand).At(at).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AaaApi.GetAaaRetentionPolicyByMoid(context.Background(), moid).Select_(select_).Expand(expand).At(at).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AaaApi.GetAaaRetentionPolicyList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
...
Other parameters are passed through a pointer to a apiGetAaaRetentionPolicyListRequest struct via the builder pattern
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AaaApi.PatchAaaRetentionPolicy(context.Background(), moid).AaaRetentionPolicy(aaaRetentionPolicy).IfMatch(ifMatch).Execute()
	if err != nil {
...
> AaaRetentionPolicy UpdateAaaRetentionPolicy(ctx, moid).AaaRetentionPolicy(aaaRetentionPolicy).IfMatch(ifMatch).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AaaApi.UpdateAaaRetentionPolicy(context.Background(), moid).AaaRetentionPolicy(aaaRetentionPolicy).IfMatch(ifMatch).Execute()
	if err != nil {
