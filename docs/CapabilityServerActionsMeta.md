...
------------ | ------------- | ------------- | -------------
**ClassId** | **string** | The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data. | [default to "capability.ServerActionsMeta"]
**ObjectType** | **string** | The fully-qualified name of the instantiated, concrete type. The value should be the same as the &#39;ClassId&#39; property. | [default to "capability.ServerActionsMeta"]
**ActionName** | Pointer to **string** | Action which will be supported using the HSU. | [optional] [readonly] 
**MinSupportedVersion** | Pointer to **string** | Firmware version below which host operation is not supported. | [optional] [readonly] 
...
### NewCapabilityServerActionsMeta
...
### NewCapabilityServerActionsMetaWithDefaults
