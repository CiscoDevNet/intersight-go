...
// VirtualizationIweDatacenterAllOf Definition of the list of properties defined in 'virtualization.IweDatacenter', excluding properties defined in parent classes.
type VirtualizationIweDatacenterAllOf struct {
...
type _VirtualizationIweDatacenterAllOf VirtualizationIweDatacenterAllOf
...
func NewVirtualizationIweDatacenterAllOf(classId string, objectType string) *VirtualizationIweDatacenterAllOf {
	this := VirtualizationIweDatacenterAllOf{}
...
func (o VirtualizationIweDatacenterAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VirtualizationIweDatacenterAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVirtualizationIweDatacenterAllOf := _VirtualizationIweDatacenterAllOf{}

	if err = json.Unmarshal(bytes, &varVirtualizationIweDatacenterAllOf); err == nil {
		*o = VirtualizationIweDatacenterAllOf(varVirtualizationIweDatacenterAllOf)
	}
...
type NullableVirtualizationIweDatacenterAllOf struct {
	value *VirtualizationIweDatacenterAllOf
	isSet bool
}

func (v NullableVirtualizationIweDatacenterAllOf) Get() *VirtualizationIweDatacenterAllOf {
	return v.value
}

func (v *NullableVirtualizationIweDatacenterAllOf) Set(val *VirtualizationIweDatacenterAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationIweDatacenterAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationIweDatacenterAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationIweDatacenterAllOf(val *VirtualizationIweDatacenterAllOf) *NullableVirtualizationIweDatacenterAllOf {
	return &NullableVirtualizationIweDatacenterAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationIweDatacenterAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationIweDatacenterAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
