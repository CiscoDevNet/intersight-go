...
// checks if the StorageHitachiCapacity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageHitachiCapacity{}
...
func (o StorageHitachiCapacity) ToMap() (map[string]interface{}, error) {
...
func (o *StorageHitachiCapacity) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varStorageHitachiCapacityWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varStorageHitachiCapacity)
	if err == nil {
