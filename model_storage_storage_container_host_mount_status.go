...
func (o *StorageStorageContainerHostMountStatus) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varStorageStorageContainerHostMountStatusWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varStorageStorageContainerHostMountStatus)
	if err == nil {
