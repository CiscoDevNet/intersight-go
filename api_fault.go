...
func (r ApiGetFaultInstanceByMoidRequest) Select_(select_ string) ApiGetFaultInstanceByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetFaultInstanceByMoidRequest) Expand(expand string) ApiGetFaultInstanceByMoidRequest {
	r.expand = &expand
	return r
}
...
func (r ApiGetFaultInstanceByMoidRequest) At(at string) ApiGetFaultInstanceByMoidRequest {
	r.at = &at
	return r
}
