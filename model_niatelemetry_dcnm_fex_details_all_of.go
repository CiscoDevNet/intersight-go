...
// NiatelemetryDcnmFexDetailsAllOf Definition of the list of properties defined in 'niatelemetry.DcnmFexDetails', excluding properties defined in parent classes.
type NiatelemetryDcnmFexDetailsAllOf struct {
...
type _NiatelemetryDcnmFexDetailsAllOf NiatelemetryDcnmFexDetailsAllOf
...
func NewNiatelemetryDcnmFexDetailsAllOf(classId string, objectType string) *NiatelemetryDcnmFexDetailsAllOf {
	this := NiatelemetryDcnmFexDetailsAllOf{}
...
func (o NiatelemetryDcnmFexDetailsAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetryDcnmFexDetailsAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetryDcnmFexDetailsAllOf := _NiatelemetryDcnmFexDetailsAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetryDcnmFexDetailsAllOf); err == nil {
		*o = NiatelemetryDcnmFexDetailsAllOf(varNiatelemetryDcnmFexDetailsAllOf)
	}
...
type NullableNiatelemetryDcnmFexDetailsAllOf struct {
	value *NiatelemetryDcnmFexDetailsAllOf
	isSet bool
}

func (v NullableNiatelemetryDcnmFexDetailsAllOf) Get() *NiatelemetryDcnmFexDetailsAllOf {
	return v.value
}

func (v *NullableNiatelemetryDcnmFexDetailsAllOf) Set(val *NiatelemetryDcnmFexDetailsAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetryDcnmFexDetailsAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetryDcnmFexDetailsAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetryDcnmFexDetailsAllOf(val *NiatelemetryDcnmFexDetailsAllOf) *NullableNiatelemetryDcnmFexDetailsAllOf {
	return &NullableNiatelemetryDcnmFexDetailsAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetryDcnmFexDetailsAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetryDcnmFexDetailsAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
