...
// checks if the FabricFcNetworkPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FabricFcNetworkPolicy{}
...
// GetDefaultClassId returns the default value "fabric.FcNetworkPolicy" of the ClassId field.
func (o *FabricFcNetworkPolicy) GetDefaultClassId() interface{} {
...
// GetDefaultObjectType returns the default value "fabric.FcNetworkPolicy" of the ObjectType field.
func (o *FabricFcNetworkPolicy) GetDefaultObjectType() interface{} {
	return "fabric.FcNetworkPolicy"
}
...
func (o *FabricFcNetworkPolicy) GetEnableTrunking() bool {
	if o == nil || IsNil(o.EnableTrunking) {
		var ret bool
		return ret
	}
...
func (o *FabricFcNetworkPolicy) SetOrganizationNil() {
...
func (o FabricFcNetworkPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *FabricFcNetworkPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFabricFcNetworkPolicyWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFabricFcNetworkPolicy)
	if err == nil {
