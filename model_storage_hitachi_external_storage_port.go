...
// StorageHitachiExternalStoragePort The HitachiExternalStoragePort object defines a port entity for external storage systems connected to the local storage system, facilitating communication and connection management. #### Purpose HitachiExternalStoragePort serves as a critical component for managing external storage ports, supporting settings related to port IDs, WWN, and iSCSI configurations. #### Key Concepts - **Port Configuration:** Provides settings for port IDs, WWN, and iSCSI IP addresses for external storage ports. - **Privilege Sets:** Ensures controlled access for managing external storage port configurations with defined privilege sets. - **Licensing:** Operates under specified entitlements, supporting authorized operations.
