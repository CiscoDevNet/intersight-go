...
// checks if the StoragePureHostUtilization type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoragePureHostUtilization{}

// StoragePureHostUtilization The PureHost object is an abstraction within PureStorage FlashArray that organizes the storage network addresses of client computers, facilitating communication between clients and volumes.   #### Purpose   PureHost serves to manage the connections and interactions between client computers and storage volumes, ensuring efficient data access and communication within the storage network.   #### Key Concepts  - **Address Management:** PureHost helps organize and control storage network addresses, optimizing connectivity and communication.  - **Shared Connectivity:** It enables shared connections between hosts and volumes, allowing multiple clients to access data efficiently.  - **Security:** PureHost utilizes privilege sets to ensure secure access and operations within the storage network.
...
func NewStoragePureHostUtilization(classId string, objectType string) *StoragePureHostUtilization {
...
func (o StoragePureHostUtilization) ToMap() (map[string]interface{}, error) {
	...
	if errStorageStorageUtilization != nil {
		return map[string]interface{}{}, errStorageStorageUtilization
	}
...
func (o *StoragePureHostUtilization) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varStoragePureHostUtilizationWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varStoragePureHostUtilization)
	if err == nil {
