...
// checks if the RecoveryBackupConfigPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryBackupConfigPolicy{}

// RecoveryBackupConfigPolicy The BackupConfigPolicy object defines comprehensive backup policies for local or remote servers. This provides the necessary inputs and configurations to execute backup operations effectively. #### Purpose The BackupConfigPolicy object defines the rules and configurations for executing backups on designated servers. It coordinates backup profiles and ensures alignment with organizational strategies, providing a structured and consistent approach to managing backup operations. #### Key Concepts - **Centralized Control:** Facilitates the management of backup profiles under a unified policy framework. - **Access Control:** Ensures that only authorized personnel can define, read, or update backup policies. - **Relationship Management:** Maintains connections to backup profiles, promoting consistency and comprehensive policy application.
...
// GetDefaultClassId returns the default value "recovery.BackupConfigPolicy" of the ClassId field.
func (o *RecoveryBackupConfigPolicy) GetDefaultClassId() interface{} {
	return "recovery.BackupConfigPolicy"
}
...
// GetDefaultObjectType returns the default value "recovery.BackupConfigPolicy" of the ObjectType field.
func (o *RecoveryBackupConfigPolicy) GetDefaultObjectType() interface{} {
	return "recovery.BackupConfigPolicy"
}
...
func (o *RecoveryBackupConfigPolicy) GetBackupProfilesOk() ([]RecoveryBackupProfileRelationship, bool) {
	if o == nil || IsNil(o.BackupProfiles) {
		return nil, false
	}
...
func (o *RecoveryBackupConfigPolicy) SetOrganizationNil() {
	o.Organization.Set(nil)
}

// UnsetOrganization ensures that no value is present for Organization, not even an explicit nil
func (o *RecoveryBackupConfigPolicy) UnsetOrganization() {
...
func (o RecoveryBackupConfigPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryBackupConfigPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varRecoveryBackupConfigPolicyWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varRecoveryBackupConfigPolicy)
	if err == nil {
