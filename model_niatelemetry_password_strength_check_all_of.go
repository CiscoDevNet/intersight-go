...
// NiatelemetryPasswordStrengthCheckAllOf Definition of the list of properties defined in 'niatelemetry.PasswordStrengthCheck', excluding properties defined in parent classes.
type NiatelemetryPasswordStrengthCheckAllOf struct {
...
type _NiatelemetryPasswordStrengthCheckAllOf NiatelemetryPasswordStrengthCheckAllOf
...
func NewNiatelemetryPasswordStrengthCheckAllOf(classId string, objectType string) *NiatelemetryPasswordStrengthCheckAllOf {
	this := NiatelemetryPasswordStrengthCheckAllOf{}
...
func (o NiatelemetryPasswordStrengthCheckAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetryPasswordStrengthCheckAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetryPasswordStrengthCheckAllOf := _NiatelemetryPasswordStrengthCheckAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetryPasswordStrengthCheckAllOf); err == nil {
		*o = NiatelemetryPasswordStrengthCheckAllOf(varNiatelemetryPasswordStrengthCheckAllOf)
	}
...
type NullableNiatelemetryPasswordStrengthCheckAllOf struct {
	value *NiatelemetryPasswordStrengthCheckAllOf
	isSet bool
}

func (v NullableNiatelemetryPasswordStrengthCheckAllOf) Get() *NiatelemetryPasswordStrengthCheckAllOf {
	return v.value
}

func (v *NullableNiatelemetryPasswordStrengthCheckAllOf) Set(val *NiatelemetryPasswordStrengthCheckAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetryPasswordStrengthCheckAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetryPasswordStrengthCheckAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetryPasswordStrengthCheckAllOf(val *NiatelemetryPasswordStrengthCheckAllOf) *NullableNiatelemetryPasswordStrengthCheckAllOf {
	return &NullableNiatelemetryPasswordStrengthCheckAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetryPasswordStrengthCheckAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetryPasswordStrengthCheckAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
