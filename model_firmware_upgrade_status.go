...
func (o FirmwareUpgradeStatus) ToMap() (map[string]interface{}, error) {
	...
	serializedConnectorCacheStatus, errConnectorCacheStatus := json.Marshal(o.ConnectorCacheStatus)
	if errConnectorCacheStatus != nil {
		return map[string]interface{}{}, errConnectorCacheStatus
	}
	errConnectorCacheStatus = json.Unmarshal([]byte(serializedConnectorCacheStatus), &toSerialize)
	if errConnectorCacheStatus != nil {
		return map[string]interface{}{}, errConnectorCacheStatus
	}
...
func (o *FirmwareUpgradeStatus) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		o.ConnectorCacheStatus = varFirmwareUpgradeStatus.ConnectorCacheStatus
	} else {
		return err
	}
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		reflectConnectorCacheStatus := reflect.ValueOf(o.ConnectorCacheStatus)
		for i := 0; i < reflectConnectorCacheStatus.Type().NumField(); i++ {
			t := reflectConnectorCacheStatus.Type().Field(i)
