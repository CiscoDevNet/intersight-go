...
func (o *ApplianceNodeOpStatus) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varApplianceNodeOpStatus.DeploymentSize = varApplianceNodeOpStatusWithoutEmbeddedStruct.DeploymentSize
