...
// checks if the HyperflexSnapshotPoint type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexSnapshotPoint{}
...
// GetDefaultClassId returns the default value "hyperflex.SnapshotPoint" of the ClassId field.
func (o *HyperflexSnapshotPoint) GetDefaultClassId() interface{} {
	return "hyperflex.SnapshotPoint"
}
...
// GetDefaultObjectType returns the default value "hyperflex.SnapshotPoint" of the ObjectType field.
func (o *HyperflexSnapshotPoint) GetDefaultObjectType() interface{} {
	return "hyperflex.SnapshotPoint"
}
...
func (o *HyperflexSnapshotPoint) GetSnapshotFiles() HyperflexSnapshotFiles {
	if o == nil || IsNil(o.SnapshotFiles.Get()) {
...
func (o *HyperflexSnapshotPoint) GetSnapshotPointEntityReference() HyperflexEntityReference {
	if o == nil || IsNil(o.SnapshotPointEntityReference.Get()) {
		var ret HyperflexEntityReference
		return ret
	}
...
func (o *HyperflexSnapshotPoint) GetVmRuntimeInfo() HyperflexVirtualMachine {
	if o == nil || IsNil(o.VmRuntimeInfo.Get()) {
...
func (o HyperflexSnapshotPoint) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexSnapshotPoint) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexSnapshotPointWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexSnapshotPoint)
	if err == nil {
