...
// checks if the IamQualifier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamQualifier{}
...
// GetDefaultClassId returns the default value "iam.Qualifier" of the ClassId field.
func (o *IamQualifier) GetDefaultClassId() interface{} {
	return "iam.Qualifier"
}
...
// GetDefaultObjectType returns the default value "iam.Qualifier" of the ObjectType field.
func (o *IamQualifier) GetDefaultObjectType() interface{} {
	return "iam.Qualifier"
}
...
func (o *IamQualifier) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIamQualifierWithoutEmbeddedStruct)
	if err == nil {
