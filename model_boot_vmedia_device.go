...
// GetDefaultClassId returns the default value "boot.VmediaDevice" of the ClassId field.
func (o *BootVmediaDevice) GetDefaultClassId() interface{} {
	return "boot.VmediaDevice"
}
...
// GetDefaultObjectType returns the default value "boot.VmediaDevice" of the ObjectType field.
func (o *BootVmediaDevice) GetDefaultObjectType() interface{} {
	return "boot.VmediaDevice"
}
...
func (o *BootVmediaDevice) SetComputePhysicalNil() {
...
func (o *BootVmediaDevice) SetInventoryDeviceInfoNil() {
...
func (o *BootVmediaDevice) SetRegisteredDeviceNil() {
...
func (o BootVmediaDevice) ToMap() (map[string]interface{}, error) {
...
func (o *BootVmediaDevice) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varBootVmediaDeviceWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varBootVmediaDevice)
	if err == nil {
