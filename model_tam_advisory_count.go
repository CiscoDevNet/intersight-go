...
// GetDefaultClassId returns the default value "tam.AdvisoryCount" of the ClassId field.
func (o *TamAdvisoryCount) GetDefaultClassId() interface{} {
	return "tam.AdvisoryCount"
}
...
// GetDefaultObjectType returns the default value "tam.AdvisoryCount" of the ObjectType field.
func (o *TamAdvisoryCount) GetDefaultObjectType() interface{} {
	return "tam.AdvisoryCount"
}
...
func (o *TamAdvisoryCount) GetAdvisoryCount() int64 {
	if o == nil || IsNil(o.AdvisoryCount) {
		var ret int64
		return ret
	}
...
func (o *TamAdvisoryCount) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o TamAdvisoryCount) ToMap() (map[string]interface{}, error) {
...
func (o *TamAdvisoryCount) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTamAdvisoryCountWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varTamAdvisoryCount)
	if err == nil {
