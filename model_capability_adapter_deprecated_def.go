...
func (o *CapabilityAdapterDeprecatedDef) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCapabilityAdapterDeprecatedDefWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varCapabilityAdapterDeprecatedDef)
	if err == nil {
