...
// NiatelemetryApicTransceiverDetailsAllOf Definition of the list of properties defined in 'niatelemetry.ApicTransceiverDetails', excluding properties defined in parent classes.
type NiatelemetryApicTransceiverDetailsAllOf struct {
...
type _NiatelemetryApicTransceiverDetailsAllOf NiatelemetryApicTransceiverDetailsAllOf
...
func NewNiatelemetryApicTransceiverDetailsAllOf(classId string, objectType string) *NiatelemetryApicTransceiverDetailsAllOf {
	this := NiatelemetryApicTransceiverDetailsAllOf{}
...
func (o NiatelemetryApicTransceiverDetailsAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetryApicTransceiverDetailsAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetryApicTransceiverDetailsAllOf := _NiatelemetryApicTransceiverDetailsAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetryApicTransceiverDetailsAllOf); err == nil {
		*o = NiatelemetryApicTransceiverDetailsAllOf(varNiatelemetryApicTransceiverDetailsAllOf)
	}
...
type NullableNiatelemetryApicTransceiverDetailsAllOf struct {
	value *NiatelemetryApicTransceiverDetailsAllOf
	isSet bool
}

func (v NullableNiatelemetryApicTransceiverDetailsAllOf) Get() *NiatelemetryApicTransceiverDetailsAllOf {
	return v.value
}

func (v *NullableNiatelemetryApicTransceiverDetailsAllOf) Set(val *NiatelemetryApicTransceiverDetailsAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetryApicTransceiverDetailsAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetryApicTransceiverDetailsAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetryApicTransceiverDetailsAllOf(val *NiatelemetryApicTransceiverDetailsAllOf) *NullableNiatelemetryApicTransceiverDetailsAllOf {
	return &NullableNiatelemetryApicTransceiverDetailsAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetryApicTransceiverDetailsAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetryApicTransceiverDetailsAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
