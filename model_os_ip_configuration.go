...
// checks if the OsIpConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OsIpConfiguration{}
...
func (o OsIpConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *OsIpConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varOsIpConfigurationWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varOsIpConfiguration)
	if err == nil {
