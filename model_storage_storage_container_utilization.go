...
func (o *StorageStorageContainerUtilization) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varStorageStorageContainerUtilizationWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varStorageStorageContainerUtilization)
	if err == nil {
