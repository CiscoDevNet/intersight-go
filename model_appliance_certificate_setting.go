...
// GetDefaultClassId returns the default value "appliance.CertificateSetting" of the ClassId field.
func (o *ApplianceCertificateSetting) GetDefaultClassId() interface{} {
	return "appliance.CertificateSetting"
}
...
// GetDefaultObjectType returns the default value "appliance.CertificateSetting" of the ObjectType field.
func (o *ApplianceCertificateSetting) GetDefaultObjectType() interface{} {
	return "appliance.CertificateSetting"
}
...
func (o *ApplianceCertificateSetting) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o *ApplianceCertificateSetting) SetCertificateNil() {
...
func (o ApplianceCertificateSetting) ToMap() (map[string]interface{}, error) {
...
func (o *ApplianceCertificateSetting) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varApplianceCertificateSettingWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varApplianceCertificateSetting)
	if err == nil {
