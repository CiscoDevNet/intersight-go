...
// checks if the BulkRequestList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkRequestList{}
...
func (o BulkRequestList) ToMap() (map[string]interface{}, error) {
...
func (o *BulkRequestList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varBulkRequestListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varBulkRequestList)
	if err == nil {
