...
// VmediaPolicyInventoryAllOf Definition of the list of properties defined in 'vmedia.PolicyInventory', excluding properties defined in parent classes.
type VmediaPolicyInventoryAllOf struct {
...
type _VmediaPolicyInventoryAllOf VmediaPolicyInventoryAllOf
...
func NewVmediaPolicyInventoryAllOf(classId string, objectType string) *VmediaPolicyInventoryAllOf {
	this := VmediaPolicyInventoryAllOf{}
...
func (o VmediaPolicyInventoryAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VmediaPolicyInventoryAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVmediaPolicyInventoryAllOf := _VmediaPolicyInventoryAllOf{}

	if err = json.Unmarshal(bytes, &varVmediaPolicyInventoryAllOf); err == nil {
		*o = VmediaPolicyInventoryAllOf(varVmediaPolicyInventoryAllOf)
	}
...
type NullableVmediaPolicyInventoryAllOf struct {
	value *VmediaPolicyInventoryAllOf
	isSet bool
}

func (v NullableVmediaPolicyInventoryAllOf) Get() *VmediaPolicyInventoryAllOf {
	return v.value
}

func (v *NullableVmediaPolicyInventoryAllOf) Set(val *VmediaPolicyInventoryAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVmediaPolicyInventoryAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVmediaPolicyInventoryAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmediaPolicyInventoryAllOf(val *VmediaPolicyInventoryAllOf) *NullableVmediaPolicyInventoryAllOf {
	return &NullableVmediaPolicyInventoryAllOf{value: val, isSet: true}
}

func (v NullableVmediaPolicyInventoryAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmediaPolicyInventoryAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
