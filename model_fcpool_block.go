...
// checks if the FcpoolBlock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FcpoolBlock{}
...
type FcpoolBlock struct {
	...
	From *string `json:"From,omitempty" validate:"regexp=^$|((^20|5[0-9a-fA-F]{1}):([0-9a-fA-F]{2}:){6}([0-9a-fA-F]{2})$)"`
	// Ending WWN identifier of the block must be in hexadecimal format xx:xx:xx:xx:xx:xx:xx:xx.
	To                   *string `json:"To,omitempty" validate:"regexp=^$|((^20|5[0-9a-fA-F]{1}):([0-9a-fA-F]{2}:){6}([0-9a-fA-F]{2})$)"`
...
// GetDefaultClassId returns the default value "fcpool.Block" of the ClassId field.
func (o *FcpoolBlock) GetDefaultClassId() interface{} {
	return "fcpool.Block"
}
...
// GetDefaultObjectType returns the default value "fcpool.Block" of the ObjectType field.
func (o *FcpoolBlock) GetDefaultObjectType() interface{} {
	return "fcpool.Block"
}
...
func (o FcpoolBlock) ToMap() (map[string]interface{}, error) {
...
func (o *FcpoolBlock) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFcpoolBlockWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFcpoolBlock)
	if err == nil {
