...
// checks if the KubernetesConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesConfiguration{}
...
// GetDefaultClassId returns the default value "kubernetes.Configuration" of the ClassId field.
func (o *KubernetesConfiguration) GetDefaultClassId() interface{} {
...
// GetDefaultObjectType returns the default value "kubernetes.Configuration" of the ObjectType field.
func (o *KubernetesConfiguration) GetDefaultObjectType() interface{} {
	return "kubernetes.Configuration"
}
...
func (o KubernetesConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *KubernetesConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varKubernetesConfigurationWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varKubernetesConfiguration)
	if err == nil {
