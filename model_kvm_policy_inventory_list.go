...
// checks if the KvmPolicyInventoryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KvmPolicyInventoryList{}
...
func (o KvmPolicyInventoryList) ToMap() (map[string]interface{}, error) {
...
func (o *KvmPolicyInventoryList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varKvmPolicyInventoryListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varKvmPolicyInventoryList)
	if err == nil {
