...
type VirtualizationVirtualMachine struct {
	...
	VmConfig             NullableMoBaseComplexType                            `json:"VmConfig,omitempty"`
...
// SetVmConfig gets a reference to the given NullableMoBaseComplexType and assigns it to the VmConfig field.
