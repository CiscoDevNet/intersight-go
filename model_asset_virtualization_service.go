...
func (o *AssetVirtualizationService) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varAssetVirtualizationServiceWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varAssetVirtualizationService)
	if err == nil {
