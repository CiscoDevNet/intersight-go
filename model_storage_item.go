...
type StorageItem struct {
	...
	// The used value (MiB) of the Local storage.
	UsedVal                *float32                                    `json:"UsedVal,omitempty"`
...
// GetUsedVal returns the UsedVal field value if set, zero value otherwise.
func (o *StorageItem) GetUsedVal() float32 {
	if o == nil || IsNil(o.UsedVal) {
		var ret float32
		return ret
	}
	return *o.UsedVal
...
// GetUsedValOk returns a tuple with the UsedVal field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StorageItem) GetUsedValOk() (*float32, bool) {
	if o == nil || IsNil(o.UsedVal) {
		return nil, false
	}
	return o.UsedVal, true
}
...
// SetUsedVal gets a reference to the given float32 and assigns it to the UsedVal field.
...
func (o *StorageItem) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varStorageItem.UsedVal = varStorageItemWithoutEmbeddedStruct.UsedVal
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "UsedVal")
