...
// checks if the WorkflowSubWorkflowTask type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowSubWorkflowTask{}
...
// GetDefaultClassId returns the default value "workflow.SubWorkflowTask" of the ClassId field.
func (o *WorkflowSubWorkflowTask) GetDefaultClassId() interface{} {
	return "workflow.SubWorkflowTask"
}
...
// GetDefaultObjectType returns the default value "workflow.SubWorkflowTask" of the ObjectType field.
func (o *WorkflowSubWorkflowTask) GetDefaultObjectType() interface{} {
	return "workflow.SubWorkflowTask"
}
...
func (o *WorkflowSubWorkflowTask) GetWorkflowDefinitionId() string {
	if o == nil || IsNil(o.WorkflowDefinitionId) {
		var ret string
		return ret
	}
...
func (o WorkflowSubWorkflowTask) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.WorkflowDefinitionId) {
...
func (o *WorkflowSubWorkflowTask) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowSubWorkflowTaskWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowSubWorkflowTask)
	if err == nil {
