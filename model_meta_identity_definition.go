...
// checks if the MetaIdentityDefinition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetaIdentityDefinition{}
...
// GetDefaultClassId returns the default value "meta.IdentityDefinition" of the ClassId field.
func (o *MetaIdentityDefinition) GetDefaultClassId() interface{} {
	return "meta.IdentityDefinition"
}
...
// GetDefaultObjectType returns the default value "meta.IdentityDefinition" of the ObjectType field.
func (o *MetaIdentityDefinition) GetDefaultObjectType() interface{} {
	return "meta.IdentityDefinition"
}
...
func (o MetaIdentityDefinition) ToMap() (map[string]interface{}, error) {
...
func (o *MetaIdentityDefinition) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varMetaIdentityDefinitionWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varMetaIdentityDefinition)
	if err == nil {
