...
// checks if the CloudNetworkAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudNetworkAddress{}
...
// GetDefaultClassId returns the default value "cloud.NetworkAddress" of the ClassId field.
func (o *CloudNetworkAddress) GetDefaultClassId() interface{} {
	return "cloud.NetworkAddress"
}
...
// GetDefaultObjectType returns the default value "cloud.NetworkAddress" of the ObjectType field.
func (o *CloudNetworkAddress) GetDefaultObjectType() interface{} {
	return "cloud.NetworkAddress"
}
...
func (o CloudNetworkAddress) ToMap() (map[string]interface{}, error) {
...
func (o *CloudNetworkAddress) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCloudNetworkAddressWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCloudNetworkAddress)
	if err == nil {
