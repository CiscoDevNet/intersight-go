...
// SoftwareApplianceDistributable The ApplianceDistributable object represents an appliance image distributed by Cisco. It is designed for upgrading on-premise Intersight Appliances, supporting both SaaS and appliance deployments. #### Purpose ApplianceDistributable serves as a downloadable image for SaaS environments and a user-uploaded image for on-premise upgrades, ensuring that Intersight Appliances remain up-to-date. #### Key Concepts - **Upgrade Facilitation:** Provides the necessary images for upgrading Intersight Appliances, maintaining system performance and security. - **Dual Use:** Supports SaaS downloadable images and on-premise appliance upgrades, offering flexibility. - **Management Integration:** Integrates with the Intersight catalog to ensure seamless upgrade processes. - **System Support:** Ensures that appliances receive essential updates to support ongoing operations.
