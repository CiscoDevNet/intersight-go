...
// checks if the AssetOrchestrationService type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetOrchestrationService{}
...
func NewAssetOrchestrationService(classId string, objectType string) *AssetOrchestrationService {
...
func (o AssetOrchestrationService) ToMap() (map[string]interface{}, error) {
...
func (o *AssetOrchestrationService) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAssetOrchestrationServiceWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAssetOrchestrationService)
	if err == nil {
