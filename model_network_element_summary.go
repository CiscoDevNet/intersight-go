...
type NetworkElementSummary struct {
	...
	// The intercluster link state of the switch. * `Unknown` - The link operational state is not known. * `Up` - The link operational state is up. * `Down` - The link operational state is down. * `Degraded` - The link is degraded but operational. This state is applicable to port channels when any one of the member links is down.
