...
// WorkflowOperationTypeDecommissionAllOf Definition of the list of properties defined in 'workflow.OperationTypeDecommission', excluding properties defined in parent classes.
type WorkflowOperationTypeDecommissionAllOf struct {
...
type _WorkflowOperationTypeDecommissionAllOf WorkflowOperationTypeDecommissionAllOf
...
func NewWorkflowOperationTypeDecommissionAllOf(classId string, objectType string) *WorkflowOperationTypeDecommissionAllOf {
	this := WorkflowOperationTypeDecommissionAllOf{}
...
func (o WorkflowOperationTypeDecommissionAllOf) MarshalJSON() ([]byte, error) {
...
func (o *WorkflowOperationTypeDecommissionAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varWorkflowOperationTypeDecommissionAllOf := _WorkflowOperationTypeDecommissionAllOf{}

	if err = json.Unmarshal(bytes, &varWorkflowOperationTypeDecommissionAllOf); err == nil {
		*o = WorkflowOperationTypeDecommissionAllOf(varWorkflowOperationTypeDecommissionAllOf)
	}
...
type NullableWorkflowOperationTypeDecommissionAllOf struct {
	value *WorkflowOperationTypeDecommissionAllOf
	isSet bool
}

func (v NullableWorkflowOperationTypeDecommissionAllOf) Get() *WorkflowOperationTypeDecommissionAllOf {
	return v.value
}

func (v *NullableWorkflowOperationTypeDecommissionAllOf) Set(val *WorkflowOperationTypeDecommissionAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkflowOperationTypeDecommissionAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkflowOperationTypeDecommissionAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkflowOperationTypeDecommissionAllOf(val *WorkflowOperationTypeDecommissionAllOf) *NullableWorkflowOperationTypeDecommissionAllOf {
	return &NullableWorkflowOperationTypeDecommissionAllOf{value: val, isSet: true}
}

func (v NullableWorkflowOperationTypeDecommissionAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkflowOperationTypeDecommissionAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
