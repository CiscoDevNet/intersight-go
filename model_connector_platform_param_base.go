...
// checks if the ConnectorPlatformParamBase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorPlatformParamBase{}
...
func NewConnectorPlatformParamBase(classId string, objectType string) *ConnectorPlatformParamBase {
...
func (o ConnectorPlatformParamBase) ToMap() (map[string]interface{}, error) {
...
func (o *ConnectorPlatformParamBase) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varConnectorPlatformParamBaseWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varConnectorPlatformParamBase)
	if err == nil {
