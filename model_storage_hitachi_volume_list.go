...
func (o *StorageHitachiVolumeList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varStorageHitachiVolumeListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varStorageHitachiVolumeList)
	if err == nil {
