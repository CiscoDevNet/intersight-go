...
type ApiGetNtpNtpServerByMoidRequest struct {
	ctx        context.Context
	ApiService *NtpApiService
	moid       string
	select_    *string
...
func (r ApiGetNtpNtpServerByMoidRequest) Select_(select_ string) ApiGetNtpNtpServerByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetNtpNtpServerByMoidRequest) Expand(expand string) ApiGetNtpNtpServerByMoidRequest {
	r.expand = &expand
	return r
}
...
func (r ApiGetNtpNtpServerByMoidRequest) At(at string) ApiGetNtpNtpServerByMoidRequest {
	r.at = &at
	return r
}

func (r ApiGetNtpNtpServerByMoidRequest) Execute() (*NtpNtpServer, *http.Response, error) {
	return r.ApiService.GetNtpNtpServerByMoidExecute(r)
}
...
func (a *NtpApiService) GetNtpNtpServerByMoidExecute(r ApiGetNtpNtpServerByMoidRequest) (*NtpNtpServer, *http.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *NtpNtpServer
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NtpApiService.GetNtpNtpServerByMoid")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/ntp/NtpServers/{Moid}"
	localVarPath = strings.Replace(localVarPath, "{"+"Moid"+"}", url.PathEscape(parameterValueToString(r.moid, "moid")), -1)
...
type ApiGetNtpNtpServerListRequest struct {
	ctx         context.Context
	ApiService  *NtpApiService
	filter      *string
	orderby     *string
...
func (r ApiGetNtpNtpServerListRequest) Filter(filter string) ApiGetNtpNtpServerListRequest {
	r.filter = &filter
	return r
}

// Determines what properties are used to sort the collection of resources.
func (r ApiGetNtpNtpServerListRequest) Orderby(orderby string) ApiGetNtpNtpServerListRequest {
	r.orderby = &orderby
	return r
}

// Specifies the maximum number of resources to return in the response.
func (r ApiGetNtpNtpServerListRequest) Top(top int32) ApiGetNtpNtpServerListRequest {
	r.top = &top
	return r
}

// Specifies the number of resources to skip in the response.
func (r ApiGetNtpNtpServerListRequest) Skip(skip int32) ApiGetNtpNtpServerListRequest {
	r.skip = &skip
	return r
}

// Specifies a subset of properties to return.
func (r ApiGetNtpNtpServerListRequest) Select_(select_ string) ApiGetNtpNtpServerListRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetNtpNtpServerListRequest) Expand(expand string) ApiGetNtpNtpServerListRequest {
	r.expand = &expand
	return r
}
...
func (r ApiGetNtpNtpServerListRequest) Apply(apply string) ApiGetNtpNtpServerListRequest {
	r.apply = &apply
	return r
}

// The $count query specifies the service should return the count of the matching resources, instead of returning the resources.
func (r ApiGetNtpNtpServerListRequest) Count(count bool) ApiGetNtpNtpServerListRequest {
	r.count = &count
	return r
}

// The $inlinecount query option allows clients to request an inline count of the matching resources included with the resources in the response.
func (r ApiGetNtpNtpServerListRequest) Inlinecount(inlinecount string) ApiGetNtpNtpServerListRequest {
	r.inlinecount = &inlinecount
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetNtpNtpServerListRequest) At(at string) ApiGetNtpNtpServerListRequest {
	r.at = &at
	return r
}

// The &#39;tags&#39; parameter is used to request a summary of the Tag utilization for this resource. When the &#39;tags&#39; parameter is specified, the response provides a list of tag keys, the number of times the key has been used across all documents, and the tag values that have been assigned to the tag key.
func (r ApiGetNtpNtpServerListRequest) Tags(tags string) ApiGetNtpNtpServerListRequest {
	r.tags = &tags
	return r
}

func (r ApiGetNtpNtpServerListRequest) Execute() (*NtpNtpServerResponse, *http.Response, error) {
	return r.ApiService.GetNtpNtpServerListExecute(r)
}
...
func (a *NtpApiService) GetNtpNtpServerListExecute(r ApiGetNtpNtpServerListRequest) (*NtpNtpServerResponse, *http.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *NtpNtpServerResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NtpApiService.GetNtpNtpServerList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/ntp/NtpServers"
...
// Specifies a subset of properties to return.
func (r ApiGetNtpPolicyByMoidRequest) Select_(select_ string) ApiGetNtpPolicyByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetNtpPolicyByMoidRequest) Expand(expand string) ApiGetNtpPolicyByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetNtpPolicyByMoidRequest) At(at string) ApiGetNtpPolicyByMoidRequest {
	r.at = &at
	return r
}
...
type ApiGetNtpPolicyInventoryByMoidRequest struct {
	ctx        context.Context
	ApiService *NtpApiService
	moid       string
	select_    *string
...
// Specifies a subset of properties to return.
func (r ApiGetNtpPolicyInventoryByMoidRequest) Select_(select_ string) ApiGetNtpPolicyInventoryByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetNtpPolicyInventoryByMoidRequest) Expand(expand string) ApiGetNtpPolicyInventoryByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetNtpPolicyInventoryByMoidRequest) At(at string) ApiGetNtpPolicyInventoryByMoidRequest {
	r.at = &at
	return r
}

func (r ApiGetNtpPolicyInventoryByMoidRequest) Execute() (*NtpPolicyInventory, *http.Response, error) {
	return r.ApiService.GetNtpPolicyInventoryByMoidExecute(r)
}

/*
GetNtpPolicyInventoryByMoid Read a 'ntp.PolicyInventory' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param moid The unique Moid identifier of a resource instance.
	@return ApiGetNtpPolicyInventoryByMoidRequest
*/
func (a *NtpApiService) GetNtpPolicyInventoryByMoid(ctx context.Context, moid string) ApiGetNtpPolicyInventoryByMoidRequest {
	return ApiGetNtpPolicyInventoryByMoidRequest{
		ApiService: a,
		ctx:        ctx,
		moid:       moid,
...
// Execute executes the request
//
//	@return NtpPolicyInventory
func (a *NtpApiService) GetNtpPolicyInventoryByMoidExecute(r ApiGetNtpPolicyInventoryByMoidRequest) (*NtpPolicyInventory, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *NtpPolicyInventory
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NtpApiService.GetNtpPolicyInventoryByMoid")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/ntp/PolicyInventories/{Moid}"
	localVarPath = strings.Replace(localVarPath, "{"+"Moid"+"}", url.PathEscape(parameterValueToString(r.moid, "moid")), -1)
...
type ApiGetNtpPolicyInventoryListRequest struct {
	ctx         context.Context
	ApiService  *NtpApiService
	filter      *string
	orderby     *string
...
// Filter criteria for the resources to return. A URI with a $filter query option identifies a subset of the entries from the Collection of Entries. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the $filter option. The expression language that is used in $filter queries supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false).
func (r ApiGetNtpPolicyInventoryListRequest) Filter(filter string) ApiGetNtpPolicyInventoryListRequest {
	r.filter = &filter
	return r
}

// Determines what properties are used to sort the collection of resources.
func (r ApiGetNtpPolicyInventoryListRequest) Orderby(orderby string) ApiGetNtpPolicyInventoryListRequest {
	r.orderby = &orderby
	return r
}

// Specifies the maximum number of resources to return in the response.
func (r ApiGetNtpPolicyInventoryListRequest) Top(top int32) ApiGetNtpPolicyInventoryListRequest {
	r.top = &top
	return r
}

// Specifies the number of resources to skip in the response.
func (r ApiGetNtpPolicyInventoryListRequest) Skip(skip int32) ApiGetNtpPolicyInventoryListRequest {
	r.skip = &skip
	return r
}

// Specifies a subset of properties to return.
func (r ApiGetNtpPolicyInventoryListRequest) Select_(select_ string) ApiGetNtpPolicyInventoryListRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetNtpPolicyInventoryListRequest) Expand(expand string) ApiGetNtpPolicyInventoryListRequest {
	r.expand = &expand
	return r
}

// Specify one or more transformation operations to perform aggregation on the resources. The transformations are processed in order with the output from a transformation being used as input for the subsequent transformation. The \&quot;$apply\&quot; query takes a sequence of set transformations, separated by forward slashes to express that they are consecutively applied, i.e., the result of each transformation is the input to the next transformation. Supported aggregation methods are \&quot;aggregate\&quot; and \&quot;groupby\&quot;. The **aggregate** transformation takes a comma-separated list of one or more aggregate expressions as parameters and returns a result set with a single instance, representing the aggregated value for all instances in the input set. The **groupby** transformation takes one or two parameters and 1. Splits the initial set into subsets where all instances in a subset have the same values for the grouping properties specified in the first parameter, 2. Applies set transformations to each subset according to the second parameter, resulting in a new set of potentially different structure and cardinality, 3. Ensures that the instances in the result set contain all grouping properties with the correct values for the group, 4. Concatenates the intermediate result sets into one result set. A groupby transformation affects the structure of the result set.
func (r ApiGetNtpPolicyInventoryListRequest) Apply(apply string) ApiGetNtpPolicyInventoryListRequest {
	r.apply = &apply
	return r
}

// The $count query specifies the service should return the count of the matching resources, instead of returning the resources.
func (r ApiGetNtpPolicyInventoryListRequest) Count(count bool) ApiGetNtpPolicyInventoryListRequest {
	r.count = &count
	return r
}

// The $inlinecount query option allows clients to request an inline count of the matching resources included with the resources in the response.
func (r ApiGetNtpPolicyInventoryListRequest) Inlinecount(inlinecount string) ApiGetNtpPolicyInventoryListRequest {
	r.inlinecount = &inlinecount
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetNtpPolicyInventoryListRequest) At(at string) ApiGetNtpPolicyInventoryListRequest {
	r.at = &at
	return r
}

// The &#39;tags&#39; parameter is used to request a summary of the Tag utilization for this resource. When the &#39;tags&#39; parameter is specified, the response provides a list of tag keys, the number of times the key has been used across all documents, and the tag values that have been assigned to the tag key.
func (r ApiGetNtpPolicyInventoryListRequest) Tags(tags string) ApiGetNtpPolicyInventoryListRequest {
	r.tags = &tags
	return r
}

func (r ApiGetNtpPolicyInventoryListRequest) Execute() (*NtpPolicyInventoryResponse, *http.Response, error) {
	return r.ApiService.GetNtpPolicyInventoryListExecute(r)
}

/*
GetNtpPolicyInventoryList Read a 'ntp.PolicyInventory' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetNtpPolicyInventoryListRequest
*/
func (a *NtpApiService) GetNtpPolicyInventoryList(ctx context.Context) ApiGetNtpPolicyInventoryListRequest {
	return ApiGetNtpPolicyInventoryListRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *NtpApiService) GetNtpPolicyInventoryListExecute(r ApiGetNtpPolicyInventoryListRequest) (*NtpPolicyInventoryResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *NtpPolicyInventoryResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NtpApiService.GetNtpPolicyInventoryList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/ntp/PolicyInventories"
