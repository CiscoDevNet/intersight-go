...
// ApicFabricLeafNodeInterface FabricLeafNodeInterface object has been deprecated. The FabricLeafNodeInterface object in Cisco APIC defines the interfaces associated with fabric leaf nodes, focusing on connectivity and communication. #### Purpose Fabric leaf node interfaces provide the necessary ports and connections for network devices, enabling seamless communication and data exchange. #### Key Concepts - **Connectivity Points:** Represents the interfaces that connect network devices to the fabric leaf nodes. - **Communication Management:** Supports the configuration and management of network interfaces for optimal data flow. - **Policy Application:** Ensures that network policies are applied consistently across leaf node interfaces.
...
// GetDefaultClassId returns the default value "apic.FabricLeafNodeInterface" of the ClassId field.
func (o *ApicFabricLeafNodeInterface) GetDefaultClassId() interface{} {
	return "apic.FabricLeafNodeInterface"
}
...
// GetDefaultObjectType returns the default value "apic.FabricLeafNodeInterface" of the ObjectType field.
func (o *ApicFabricLeafNodeInterface) GetDefaultObjectType() interface{} {
	return "apic.FabricLeafNodeInterface"
}
