...
// IamUserSetting UserSetting stores specific UI-related settings that are not part of general preferences, such as session recording opt-in status. #### Purpose It allows storing discrete user settings that drive UI features and compliance preferences. #### Key Concepts - **Fine-grained Settings:** Captures individual flags or controls. - **Per-user Scope:** Stored per user and IdP/IdP reference context. - **Complementary to Preferences:** Designed for settings distinct from bulk UI preferences. - **Self-managed:** Users can create and update their own settings.
type IamUserSetting struct {
	...
	DefaultPermission       []IamDefaultPermissionInfo `json:"DefaultPermission,omitempty"`
...
// GetDefaultPermission returns the DefaultPermission field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *IamUserSetting) GetDefaultPermission() []IamDefaultPermissionInfo {
	if o == nil {
		var ret []IamDefaultPermissionInfo
		return ret
	}
	return o.DefaultPermission
}

// GetDefaultPermissionOk returns a tuple with the DefaultPermission field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *IamUserSetting) GetDefaultPermissionOk() ([]IamDefaultPermissionInfo, bool) {
	if o == nil || IsNil(o.DefaultPermission) {
		return nil, false
	}
	return o.DefaultPermission, true
}
...
// SetDefaultPermission gets a reference to the given []IamDefaultPermissionInfo and assigns it to the DefaultPermission field.
func (o *IamUserSetting) SetDefaultPermission(v []IamDefaultPermissionInfo) {
	o.DefaultPermission = v
}
...
func (o IamUserSetting) ToMap() (map[string]interface{}, error) {
	...
	if o.DefaultPermission != nil {
		toSerialize["DefaultPermission"] = o.DefaultPermission
	}
...
func (o *IamUserSetting) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varIamUserSetting.DefaultPermission = varIamUserSettingWithoutEmbeddedStruct.DefaultPermission
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "DefaultPermission")
