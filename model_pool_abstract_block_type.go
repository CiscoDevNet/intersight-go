...
// checks if the PoolAbstractBlockType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PoolAbstractBlockType{}
...
func (o PoolAbstractBlockType) ToMap() (map[string]interface{}, error) {
...
func (o *PoolAbstractBlockType) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPoolAbstractBlockTypeWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varPoolAbstractBlockType)
	if err == nil {
