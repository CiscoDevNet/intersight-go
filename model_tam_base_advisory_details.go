...
// checks if the TamBaseAdvisoryDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TamBaseAdvisoryDetails{}
...
func (o TamBaseAdvisoryDetails) ToMap() (map[string]interface{}, error) {
...
func (o *TamBaseAdvisoryDetails) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTamBaseAdvisoryDetailsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varTamBaseAdvisoryDetails)
	if err == nil {
