...
// checks if the WorkflowTargetContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowTargetContext{}

// WorkflowTargetContext Target context holds information about the Intersight managed object on which the workflow is executing and hence the entity that is being affected by the workflow. The target could be an Intersight asset Target like HTTP Endpoint or it can be an entity like an adapter in the Chassis.
...
// GetDefaultClassId returns the default value "workflow.TargetContext" of the ClassId field.
func (o *WorkflowTargetContext) GetDefaultClassId() interface{} {
	return "workflow.TargetContext"
}
...
// GetDefaultObjectType returns the default value "workflow.TargetContext" of the ObjectType field.
func (o *WorkflowTargetContext) GetDefaultObjectType() interface{} {
	return "workflow.TargetContext"
}
...
func (o WorkflowTargetContext) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowTargetContext) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowTargetContextWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowTargetContext)
	if err == nil {
