...
// HyperflexHypervisorHost ### Overview The HypervisorHost object represents a physical or virtual host appliance within the HyperFlex Cluster. This provides a detailed interface for managing host resources, including status, role, and configuration, supporting efficient cluster operation and management. #### Purpose A HypervisorHost serves as a critical node within the HyperFlex infrastructure, enabling the deployment and management of virtualized environments through resource allocation and operational control. #### Key Concepts - **Status Monitoring:** - Tracks host status, including operational state and maintenance mode, to ensure reliable cluster performance. - **Role Definition:** - Defines the specific role of the host within the HyperFlex environment, such as storage or compute. - **Cluster Association:** - Ensures seamless integration with the HyperFlex Cluster, supporting coordinated resource management and operational efficiency.
...
// GetDefaultClassId returns the default value "hyperflex.HypervisorHost" of the ClassId field.
func (o *HyperflexHypervisorHost) GetDefaultClassId() interface{} {
	return "hyperflex.HypervisorHost"
}
...
// GetDefaultObjectType returns the default value "hyperflex.HypervisorHost" of the ObjectType field.
func (o *HyperflexHypervisorHost) GetDefaultObjectType() interface{} {
	return "hyperflex.HypervisorHost"
}
