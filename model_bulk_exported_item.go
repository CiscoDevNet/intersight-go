...
type BulkExportedItem struct {
	...
	Export        NullableBulkBaseExportRelationship   `json:"Export,omitempty"`
...
func (o *BulkExportedItem) GetExport() BulkBaseExportRelationship {
	if o == nil || IsNil(o.Export.Get()) {
		var ret BulkBaseExportRelationship
		return ret
	}
	return *o.Export.Get()
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkExportedItem) GetExportOk() (*BulkBaseExportRelationship, bool) {
	if o == nil {
		return nil, false
	}
...
// SetExport gets a reference to the given NullableBulkBaseExportRelationship and assigns it to the Export field.
func (o *BulkExportedItem) SetExport(v BulkBaseExportRelationship) {
	o.Export.Set(&v)
}
