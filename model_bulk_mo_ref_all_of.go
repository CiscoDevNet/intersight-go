...
// BulkMoRefAllOf Definition of the list of properties defined in 'bulk.MoRef', excluding properties defined in parent classes.
type BulkMoRefAllOf struct {
...
type _BulkMoRefAllOf BulkMoRefAllOf
...
func NewBulkMoRefAllOfWithDefaults() *BulkMoRefAllOf {
	this := BulkMoRefAllOf{}
	var classId string = "bulk.MoRef"
	this.ClassId = classId
	var objectType string = "bulk.MoRef"
	this.ObjectType = objectType
	return &this
}
...
func (o BulkMoRefAllOf) MarshalJSON() ([]byte, error) {
...
func (o *BulkMoRefAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varBulkMoRefAllOf := _BulkMoRefAllOf{}

	if err = json.Unmarshal(bytes, &varBulkMoRefAllOf); err == nil {
		*o = BulkMoRefAllOf(varBulkMoRefAllOf)
	}
...
type NullableBulkMoRefAllOf struct {
	value *BulkMoRefAllOf
	isSet bool
}

func (v NullableBulkMoRefAllOf) Get() *BulkMoRefAllOf {
	return v.value
}

func (v *NullableBulkMoRefAllOf) Set(val *BulkMoRefAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkMoRefAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkMoRefAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkMoRefAllOf(val *BulkMoRefAllOf) *NullableBulkMoRefAllOf {
	return &NullableBulkMoRefAllOf{value: val, isSet: true}
}

func (v NullableBulkMoRefAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkMoRefAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
