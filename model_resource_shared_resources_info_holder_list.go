...
// checks if the ResourceSharedResourcesInfoHolderList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceSharedResourcesInfoHolderList{}
...
func (o ResourceSharedResourcesInfoHolderList) ToMap() (map[string]interface{}, error) {
...
func (o *ResourceSharedResourcesInfoHolderList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varResourceSharedResourcesInfoHolderListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varResourceSharedResourcesInfoHolderList)
	if err == nil {
