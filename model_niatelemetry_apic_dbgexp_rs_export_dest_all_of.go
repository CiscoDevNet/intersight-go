...
// NiatelemetryApicDbgexpRsExportDestAllOf Definition of the list of properties defined in 'niatelemetry.ApicDbgexpRsExportDest', excluding properties defined in parent classes.
type NiatelemetryApicDbgexpRsExportDestAllOf struct {
...
type _NiatelemetryApicDbgexpRsExportDestAllOf NiatelemetryApicDbgexpRsExportDestAllOf
...
func NewNiatelemetryApicDbgexpRsExportDestAllOf(classId string, objectType string) *NiatelemetryApicDbgexpRsExportDestAllOf {
	this := NiatelemetryApicDbgexpRsExportDestAllOf{}
...
func (o NiatelemetryApicDbgexpRsExportDestAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetryApicDbgexpRsExportDestAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetryApicDbgexpRsExportDestAllOf := _NiatelemetryApicDbgexpRsExportDestAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetryApicDbgexpRsExportDestAllOf); err == nil {
		*o = NiatelemetryApicDbgexpRsExportDestAllOf(varNiatelemetryApicDbgexpRsExportDestAllOf)
	}
...
type NullableNiatelemetryApicDbgexpRsExportDestAllOf struct {
	value *NiatelemetryApicDbgexpRsExportDestAllOf
	isSet bool
}

func (v NullableNiatelemetryApicDbgexpRsExportDestAllOf) Get() *NiatelemetryApicDbgexpRsExportDestAllOf {
	return v.value
}

func (v *NullableNiatelemetryApicDbgexpRsExportDestAllOf) Set(val *NiatelemetryApicDbgexpRsExportDestAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetryApicDbgexpRsExportDestAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetryApicDbgexpRsExportDestAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetryApicDbgexpRsExportDestAllOf(val *NiatelemetryApicDbgexpRsExportDestAllOf) *NullableNiatelemetryApicDbgexpRsExportDestAllOf {
	return &NullableNiatelemetryApicDbgexpRsExportDestAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetryApicDbgexpRsExportDestAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetryApicDbgexpRsExportDestAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
