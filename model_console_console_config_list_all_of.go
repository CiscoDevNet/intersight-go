...
// ConsoleConsoleConfigListAllOf struct for ConsoleConsoleConfigListAllOf
type ConsoleConsoleConfigListAllOf struct {
...
type _ConsoleConsoleConfigListAllOf ConsoleConsoleConfigListAllOf
...
func NewConsoleConsoleConfigListAllOf() *ConsoleConsoleConfigListAllOf {
	this := ConsoleConsoleConfigListAllOf{}
	return &this
}
...
func (o ConsoleConsoleConfigListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ConsoleConsoleConfigListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varConsoleConsoleConfigListAllOf := _ConsoleConsoleConfigListAllOf{}

	if err = json.Unmarshal(bytes, &varConsoleConsoleConfigListAllOf); err == nil {
		*o = ConsoleConsoleConfigListAllOf(varConsoleConsoleConfigListAllOf)
	}
...
type NullableConsoleConsoleConfigListAllOf struct {
	value *ConsoleConsoleConfigListAllOf
	isSet bool
}

func (v NullableConsoleConsoleConfigListAllOf) Get() *ConsoleConsoleConfigListAllOf {
	return v.value
}

func (v *NullableConsoleConsoleConfigListAllOf) Set(val *ConsoleConsoleConfigListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableConsoleConsoleConfigListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableConsoleConsoleConfigListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConsoleConsoleConfigListAllOf(val *ConsoleConsoleConfigListAllOf) *NullableConsoleConsoleConfigListAllOf {
	return &NullableConsoleConsoleConfigListAllOf{value: val, isSet: true}
}

func (v NullableConsoleConsoleConfigListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConsoleConsoleConfigListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
