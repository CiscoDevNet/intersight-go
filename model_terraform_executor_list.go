...
func (o *TerraformExecutorList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varTerraformExecutorListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varTerraformExecutorList)
	if err == nil {
