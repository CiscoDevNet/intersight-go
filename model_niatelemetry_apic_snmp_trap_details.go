...
// checks if the NiatelemetryApicSnmpTrapDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiatelemetryApicSnmpTrapDetails{}
...
// GetDefaultClassId returns the default value "niatelemetry.ApicSnmpTrapDetails" of the ClassId field.
func (o *NiatelemetryApicSnmpTrapDetails) GetDefaultClassId() interface{} {
	return "niatelemetry.ApicSnmpTrapDetails"
}
...
// GetDefaultObjectType returns the default value "niatelemetry.ApicSnmpTrapDetails" of the ObjectType field.
func (o *NiatelemetryApicSnmpTrapDetails) GetDefaultObjectType() interface{} {
	return "niatelemetry.ApicSnmpTrapDetails"
}
...
func (o *NiatelemetryApicSnmpTrapDetails) SetRegisteredDeviceNil() {
...
func (o NiatelemetryApicSnmpTrapDetails) ToMap() (map[string]interface{}, error) {
...
func (o *NiatelemetryApicSnmpTrapDetails) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiatelemetryApicSnmpTrapDetailsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiatelemetryApicSnmpTrapDetails)
	if err == nil {
