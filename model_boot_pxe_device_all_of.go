...
// BootPxeDeviceAllOf Definition of the list of properties defined in 'boot.PxeDevice', excluding properties defined in parent classes.
type BootPxeDeviceAllOf struct {
...
type _BootPxeDeviceAllOf BootPxeDeviceAllOf
...
func (o BootPxeDeviceAllOf) MarshalJSON() ([]byte, error) {
...
func (o *BootPxeDeviceAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varBootPxeDeviceAllOf := _BootPxeDeviceAllOf{}

	if err = json.Unmarshal(bytes, &varBootPxeDeviceAllOf); err == nil {
		*o = BootPxeDeviceAllOf(varBootPxeDeviceAllOf)
	}
...
type NullableBootPxeDeviceAllOf struct {
	value *BootPxeDeviceAllOf
	isSet bool
}

func (v NullableBootPxeDeviceAllOf) Get() *BootPxeDeviceAllOf {
	return v.value
}

func (v *NullableBootPxeDeviceAllOf) Set(val *BootPxeDeviceAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBootPxeDeviceAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBootPxeDeviceAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBootPxeDeviceAllOf(val *BootPxeDeviceAllOf) *NullableBootPxeDeviceAllOf {
	return &NullableBootPxeDeviceAllOf{value: val, isSet: true}
}

func (v NullableBootPxeDeviceAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBootPxeDeviceAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
