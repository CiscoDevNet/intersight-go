...
// StorageHitachiExternalStorageLun The HitachiExternalStorageLun object represents a list of logical units defined for external storage ports connected to the local storage system, supporting LUN management and operations. #### Purpose HitachiExternalStorageLun is designed to manage logical units within external storage ports, facilitating operations related to LUN settings and capacities. #### Key Concepts - **LUN Management:** Defines settings for LUNs, including port IDs, WWN, and capacity information for external storage systems. - **Privilege Sets:** Provides controlled access for managing external storage LUN settings with defined privilege sets. - **Licensing:** Supports operations under specified entitlements, adhering to licensing requirements.
