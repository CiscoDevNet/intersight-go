...
// checks if the ConnectorStreamInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorStreamInput{}
...
func (o ConnectorStreamInput) ToMap() (map[string]interface{}, error) {
...
func (o *ConnectorStreamInput) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varConnectorStreamInputWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varConnectorStreamInput)
	if err == nil {
