...
// checks if the BulkMultiRelationEntryPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkMultiRelationEntryPatch{}
...
func (o BulkMultiRelationEntryPatch) ToMap() (map[string]interface{}, error) {
...
func (o *BulkMultiRelationEntryPatch) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varBulkMultiRelationEntryPatchWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varBulkMultiRelationEntryPatch)
	if err == nil {
