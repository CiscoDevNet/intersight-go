...
// CondAlarmDefinitionAllOf Definition of the list of properties defined in 'cond.AlarmDefinition', excluding properties defined in parent classes.
type CondAlarmDefinitionAllOf struct {
...
type _CondAlarmDefinitionAllOf CondAlarmDefinitionAllOf
...
func (o CondAlarmDefinitionAllOf) MarshalJSON() ([]byte, error) {
...
func (o *CondAlarmDefinitionAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCondAlarmDefinitionAllOf := _CondAlarmDefinitionAllOf{}

	if err = json.Unmarshal(bytes, &varCondAlarmDefinitionAllOf); err == nil {
		*o = CondAlarmDefinitionAllOf(varCondAlarmDefinitionAllOf)
	}
...
type NullableCondAlarmDefinitionAllOf struct {
	value *CondAlarmDefinitionAllOf
	isSet bool
}

func (v NullableCondAlarmDefinitionAllOf) Get() *CondAlarmDefinitionAllOf {
	return v.value
}

func (v *NullableCondAlarmDefinitionAllOf) Set(val *CondAlarmDefinitionAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCondAlarmDefinitionAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCondAlarmDefinitionAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCondAlarmDefinitionAllOf(val *CondAlarmDefinitionAllOf) *NullableCondAlarmDefinitionAllOf {
	return &NullableCondAlarmDefinitionAllOf{value: val, isSet: true}
}

func (v NullableCondAlarmDefinitionAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCondAlarmDefinitionAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
