...
// checks if the StorageHitachiPoolList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageHitachiPoolList{}
...
func (o StorageHitachiPoolList) ToMap() (map[string]interface{}, error) {
...
func (o *StorageHitachiPoolList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varStorageHitachiPoolListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varStorageHitachiPoolList)
	if err == nil {
