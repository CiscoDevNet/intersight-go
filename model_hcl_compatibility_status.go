...
// checks if the HclCompatibilityStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HclCompatibilityStatus{}

// HclCompatibilityStatus ### Overview The CompatibilityStatus object evaluates the compatibility of hardware and software configurations within the system. This provides insights into the compatibility status of various configurations, aiding in decision-making and system optimization. #### Purpose CompatibilityStatus is integral to ensuring that hardware and software components are compatible with each other. It facilitates the evaluation of configurations to determine their suitability for deployment within the system. #### Key Concepts - **Configuration Evaluation:** - Enables the assessment of compatibility across diverse hardware and software configurations, helping to identify potential issues before deployment. - **Request Types:** - Offers flexible request types to serve different compatibility evaluation needs, from checking compatibility to filling supported version details. - **Access Control:** - Privilege sets dictate who can interact with the CompatibilityStatus object, ensuring secure and appropriate usage. - **Entitlements and Licenses:** - Operates under specific entitlements, aligning with organizational policies and ensuring compliance with licensing requirements.
...
// GetDefaultClassId returns the default value "hcl.CompatibilityStatus" of the ClassId field.
func (o *HclCompatibilityStatus) GetDefaultClassId() interface{} {
	return "hcl.CompatibilityStatus"
}
...
// GetDefaultObjectType returns the default value "hcl.CompatibilityStatus" of the ObjectType field.
func (o *HclCompatibilityStatus) GetDefaultObjectType() interface{} {
	return "hcl.CompatibilityStatus"
}
...
func (o HclCompatibilityStatus) ToMap() (map[string]interface{}, error) {
...
func (o *HclCompatibilityStatus) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHclCompatibilityStatusWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHclCompatibilityStatus)
	if err == nil {
