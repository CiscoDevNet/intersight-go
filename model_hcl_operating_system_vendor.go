...
// checks if the HclOperatingSystemVendor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HclOperatingSystemVendor{}
...
// GetDefaultClassId returns the default value "hcl.OperatingSystemVendor" of the ClassId field.
func (o *HclOperatingSystemVendor) GetDefaultClassId() interface{} {
	return "hcl.OperatingSystemVendor"
}
...
// GetDefaultObjectType returns the default value "hcl.OperatingSystemVendor" of the ObjectType field.
func (o *HclOperatingSystemVendor) GetDefaultObjectType() interface{} {
	return "hcl.OperatingSystemVendor"
}
...
func (o HclOperatingSystemVendor) ToMap() (map[string]interface{}, error) {
...
func (o *HclOperatingSystemVendor) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHclOperatingSystemVendorWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHclOperatingSystemVendor)
	if err == nil {
