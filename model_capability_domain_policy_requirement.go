...
type CapabilityDomainPolicyRequirement struct {
	...
	SwitchControlPolicyConstraints NullableCapabilitySwitchControlPolicyConstraints `json:"SwitchControlPolicyConstraints,omitempty"`
...
// GetSwitchControlPolicyConstraints returns the SwitchControlPolicyConstraints field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CapabilityDomainPolicyRequirement) GetSwitchControlPolicyConstraints() CapabilitySwitchControlPolicyConstraints {
	if o == nil || IsNil(o.SwitchControlPolicyConstraints.Get()) {
		var ret CapabilitySwitchControlPolicyConstraints
		return ret
	}
	return *o.SwitchControlPolicyConstraints.Get()
}

// GetSwitchControlPolicyConstraintsOk returns a tuple with the SwitchControlPolicyConstraints field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CapabilityDomainPolicyRequirement) GetSwitchControlPolicyConstraintsOk() (*CapabilitySwitchControlPolicyConstraints, bool) {
	...
	return o.SwitchControlPolicyConstraints.Get(), o.SwitchControlPolicyConstraints.IsSet()
}
...
func (o *CapabilityDomainPolicyRequirement) HasSwitchControlPolicyConstraints() bool {
	if o != nil && o.SwitchControlPolicyConstraints.IsSet() {
		return true
	}
...
// SetSwitchControlPolicyConstraints gets a reference to the given NullableCapabilitySwitchControlPolicyConstraints and assigns it to the SwitchControlPolicyConstraints field.
func (o *CapabilityDomainPolicyRequirement) SetSwitchControlPolicyConstraints(v CapabilitySwitchControlPolicyConstraints) {
	o.SwitchControlPolicyConstraints.Set(&v)
}

// SetSwitchControlPolicyConstraintsNil sets the value for SwitchControlPolicyConstraints to be an explicit nil
func (o *CapabilityDomainPolicyRequirement) SetSwitchControlPolicyConstraintsNil() {
	o.SwitchControlPolicyConstraints.Set(nil)
}
...
func (o *CapabilityDomainPolicyRequirement) UnsetSwitchControlPolicyConstraints() {
	o.SwitchControlPolicyConstraints.Unset()
}
...
func (o CapabilityDomainPolicyRequirement) ToMap() (map[string]interface{}, error) {
	...
	if o.SwitchControlPolicyConstraints.IsSet() {
		toSerialize["SwitchControlPolicyConstraints"] = o.SwitchControlPolicyConstraints.Get()
	}
...
func (o *CapabilityDomainPolicyRequirement) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varCapabilityDomainPolicyRequirement.SwitchControlPolicyConstraints = varCapabilityDomainPolicyRequirementWithoutEmbeddedStruct.SwitchControlPolicyConstraints
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "SwitchControlPolicyConstraints")
