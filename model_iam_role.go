...
// GetDefaultClassId returns the default value "iam.Role" of the ClassId field.
func (o *IamRole) GetDefaultClassId() interface{} {
	return "iam.Role"
}
...
// GetDefaultObjectType returns the default value "iam.Role" of the ObjectType field.
func (o *IamRole) GetDefaultObjectType() interface{} {
	return "iam.Role"
}
...
func (o *IamRole) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIamRoleWithoutEmbeddedStruct)
	if err == nil {
		varIamRole := _IamRole{}
