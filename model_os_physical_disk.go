...
// checks if the OsPhysicalDisk type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OsPhysicalDisk{}
...
// GetDefaultClassId returns the default value "os.PhysicalDisk" of the ClassId field.
func (o *OsPhysicalDisk) GetDefaultClassId() interface{} {
	return "os.PhysicalDisk"
}
...
// GetDefaultObjectType returns the default value "os.PhysicalDisk" of the ObjectType field.
func (o *OsPhysicalDisk) GetDefaultObjectType() interface{} {
	return "os.PhysicalDisk"
}
...
func (o OsPhysicalDisk) ToMap() (map[string]interface{}, error) {
...
func (o *OsPhysicalDisk) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varOsPhysicalDiskWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varOsPhysicalDisk)
	if err == nil {
