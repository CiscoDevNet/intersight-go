...
// StorageHitachiPool The HitachiPool object represents a pool entity within the Hitachi storage array, designed to manage and configure storage pools efficiently. This provides functionalities for monitoring and executing various operations related to storage pool management. #### Purpose HitachiPool serves as a pivotal element for managing storage pools, supporting the definition of execution modes, monitoring settings, and capacity thresholds. #### Key Concepts - **Capacity Management:** Handles total reserved capacity and threshold settings, ensuring optimal pool performance and resource allocation. - **Monitoring:** Supports performance monitoring execution modes, providing insights into pool operations. - **Privilege Sets:** Offers controlled access for pool management tasks with defined privilege sets. - **Licensing:** Complies with licensing operations under specified entitlements.
