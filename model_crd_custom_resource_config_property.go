...
// checks if the CrdCustomResourceConfigProperty type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CrdCustomResourceConfigProperty{}

// CrdCustomResourceConfigProperty Defines a configurable property for the custom resource.
...
// GetDefaultClassId returns the default value "crd.CustomResourceConfigProperty" of the ClassId field.
func (o *CrdCustomResourceConfigProperty) GetDefaultClassId() interface{} {
	return "crd.CustomResourceConfigProperty"
}
...
// GetDefaultObjectType returns the default value "crd.CustomResourceConfigProperty" of the ObjectType field.
func (o *CrdCustomResourceConfigProperty) GetDefaultObjectType() interface{} {
	return "crd.CustomResourceConfigProperty"
}
...
func (o CrdCustomResourceConfigProperty) ToMap() (map[string]interface{}, error) {
...
func (o *CrdCustomResourceConfigProperty) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCrdCustomResourceConfigPropertyWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCrdCustomResourceConfigProperty)
	if err == nil {
