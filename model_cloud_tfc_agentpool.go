...
// CloudTfcAgentpool The TfcAgentpool object is integral to managing groups of agents within Terraform Cloud, enabling communication with isolated, private, or on-premises infrastructure.  #### Purpose Intersight discovers the Agent Pools in the Terraform Cloud account whose credentials are specified in the Terraform Cloud target. #### Key Concepts - **Agent Grouping:** Represents a collection of Terraform Cloud agents used to execute runs against private, isolated, or on-premises environments. - **Credential-Based Discovery:** Intersight identifies available agent pools using the credentials specified in the Terraform Cloud target.
...
// GetDefaultClassId returns the default value "cloud.TfcAgentpool" of the ClassId field.
func (o *CloudTfcAgentpool) GetDefaultClassId() interface{} {
	return "cloud.TfcAgentpool"
}
...
// GetDefaultObjectType returns the default value "cloud.TfcAgentpool" of the ObjectType field.
func (o *CloudTfcAgentpool) GetDefaultObjectType() interface{} {
	return "cloud.TfcAgentpool"
}
