...
// checks if the LicenseIksLicenseCountList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LicenseIksLicenseCountList{}
...
func (o LicenseIksLicenseCountList) ToMap() (map[string]interface{}, error) {
...
func (o *LicenseIksLicenseCountList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varLicenseIksLicenseCountListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varLicenseIksLicenseCountList)
	if err == nil {
