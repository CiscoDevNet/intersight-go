...
type _HyperflexHealthCheckPackageChecksumListAllOf HyperflexHealthCheckPackageChecksumListAllOf
...
func (o *HyperflexHealthCheckPackageChecksumListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varHyperflexHealthCheckPackageChecksumListAllOf := _HyperflexHealthCheckPackageChecksumListAllOf{}

	if err = json.Unmarshal(bytes, &varHyperflexHealthCheckPackageChecksumListAllOf); err == nil {
		*o = HyperflexHealthCheckPackageChecksumListAllOf(varHyperflexHealthCheckPackageChecksumListAllOf)
	}
