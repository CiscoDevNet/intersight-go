...
func (o *SwIdPoolBase) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varSwIdPoolBaseWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varSwIdPoolBase)
	if err == nil {
