...
// GetDefaultClassId returns the default value "bios.SystemBootOrder" of the ClassId field.
func (o *BiosSystemBootOrder) GetDefaultClassId() interface{} {
	return "bios.SystemBootOrder"
}
...
// GetDefaultObjectType returns the default value "bios.SystemBootOrder" of the ObjectType field.
func (o *BiosSystemBootOrder) GetDefaultObjectType() interface{} {
	return "bios.SystemBootOrder"
}
...
func (o *BiosSystemBootOrder) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		o.EquipmentBase = varBiosSystemBootOrder.EquipmentBase
	} else {
		return err
	}
