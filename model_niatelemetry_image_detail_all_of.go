...
// NiatelemetryImageDetailAllOf Definition of the list of properties defined in 'niatelemetry.ImageDetail', excluding properties defined in parent classes.
type NiatelemetryImageDetailAllOf struct {
...
type _NiatelemetryImageDetailAllOf NiatelemetryImageDetailAllOf
...
func NewNiatelemetryImageDetailAllOf(classId string, objectType string) *NiatelemetryImageDetailAllOf {
	this := NiatelemetryImageDetailAllOf{}
...
func (o NiatelemetryImageDetailAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetryImageDetailAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetryImageDetailAllOf := _NiatelemetryImageDetailAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetryImageDetailAllOf); err == nil {
		*o = NiatelemetryImageDetailAllOf(varNiatelemetryImageDetailAllOf)
	}
...
type NullableNiatelemetryImageDetailAllOf struct {
	value *NiatelemetryImageDetailAllOf
	isSet bool
}

func (v NullableNiatelemetryImageDetailAllOf) Get() *NiatelemetryImageDetailAllOf {
	return v.value
}

func (v *NullableNiatelemetryImageDetailAllOf) Set(val *NiatelemetryImageDetailAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetryImageDetailAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetryImageDetailAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetryImageDetailAllOf(val *NiatelemetryImageDetailAllOf) *NullableNiatelemetryImageDetailAllOf {
	return &NullableNiatelemetryImageDetailAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetryImageDetailAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetryImageDetailAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
