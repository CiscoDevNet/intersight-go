...
// AssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf Definition of the list of properties defined in 'asset.WorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptions', excluding properties defined in parent classes.
type AssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf struct {
...
type _AssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf AssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf
...
func NewAssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf(classId string, objectType string) *AssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf {
	this := AssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf{}
...
func (o AssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf) MarshalJSON() ([]byte, error) {
...
func (o *AssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varAssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf := _AssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf{}

	if err = json.Unmarshal(bytes, &varAssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf); err == nil {
		*o = AssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf(varAssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf)
	}
...
type NullableAssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf struct {
	value *AssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf
	isSet bool
}

func (v NullableAssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf) Get() *AssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf {
	return v.value
}

func (v *NullableAssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf) Set(val *AssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf(val *AssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf) *NullableAssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf {
	return &NullableAssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf{value: val, isSet: true}
}

func (v NullableAssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssetWorkloadOptimizerMicrosoftAzureEnterpriseAgreementOptionsAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
