...
// VnicFcIfInventoryListAllOf struct for VnicFcIfInventoryListAllOf
type VnicFcIfInventoryListAllOf struct {
...
type _VnicFcIfInventoryListAllOf VnicFcIfInventoryListAllOf
...
func NewVnicFcIfInventoryListAllOf() *VnicFcIfInventoryListAllOf {
	this := VnicFcIfInventoryListAllOf{}
	return &this
}
...
func (o VnicFcIfInventoryListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VnicFcIfInventoryListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVnicFcIfInventoryListAllOf := _VnicFcIfInventoryListAllOf{}

	if err = json.Unmarshal(bytes, &varVnicFcIfInventoryListAllOf); err == nil {
		*o = VnicFcIfInventoryListAllOf(varVnicFcIfInventoryListAllOf)
	}
...
type NullableVnicFcIfInventoryListAllOf struct {
	value *VnicFcIfInventoryListAllOf
	isSet bool
}

func (v NullableVnicFcIfInventoryListAllOf) Get() *VnicFcIfInventoryListAllOf {
	return v.value
}

func (v *NullableVnicFcIfInventoryListAllOf) Set(val *VnicFcIfInventoryListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVnicFcIfInventoryListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVnicFcIfInventoryListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVnicFcIfInventoryListAllOf(val *VnicFcIfInventoryListAllOf) *NullableVnicFcIfInventoryListAllOf {
	return &NullableVnicFcIfInventoryListAllOf{value: val, isSet: true}
}

func (v NullableVnicFcIfInventoryListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVnicFcIfInventoryListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
