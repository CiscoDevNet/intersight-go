...
// NotificationAction Action abstract complex type describes the action the framework should perform when the event matched with a specific subscription is found. Ex.: Send Email, Send Mobile Push, Publish to a specific topic, etc.
...
func (o *NotificationAction) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNotificationActionWithoutEmbeddedStruct)
	if err == nil {
