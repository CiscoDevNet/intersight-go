...
func (o *UuidpoolBlockAllOf) GetReservations() []UuidpoolReservationRelationship {
	if o == nil {
...
func (o *UuidpoolBlockAllOf) GetReservationsOk() ([]UuidpoolReservationRelationship, bool) {
...
func (o *UuidpoolBlockAllOf) HasReservations() bool {
	if o != nil && o.Reservations != nil {
		return true
	}
...
func (o *UuidpoolBlockAllOf) SetReservations(v []UuidpoolReservationRelationship) {
	o.Reservations = v
}
