...
// StorageHitachiExternalParityGroup The HitachiExternalParityGroup object defines an external parity group within the Hitachi storage array, encapsulating attributes related to external storage connections. #### Purpose HitachiExternalParityGroup serves as the foundational element for managing external parity groups, supporting operations related to capacity, utilization, and emulation settings. #### Key Concepts - **External Storage Management:** Manages usage rates, capacities, and emulation types for external parity groups. - **Privilege Sets:** Ensures secure management of external parity group settings with defined privilege sets. - **Licensing:** Operates under specified entitlements, supporting authorized operations.
