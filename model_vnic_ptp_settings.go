...
// checks if the VnicPtpSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VnicPtpSettings{}
...
// GetDefaultClassId returns the default value "vnic.PtpSettings" of the ClassId field.
func (o *VnicPtpSettings) GetDefaultClassId() interface{} {
	return "vnic.PtpSettings"
}
...
// GetDefaultObjectType returns the default value "vnic.PtpSettings" of the ObjectType field.
func (o *VnicPtpSettings) GetDefaultObjectType() interface{} {
	return "vnic.PtpSettings"
}
...
func (o VnicPtpSettings) ToMap() (map[string]interface{}, error) {
...
func (o *VnicPtpSettings) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVnicPtpSettingsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVnicPtpSettings)
	if err == nil {
