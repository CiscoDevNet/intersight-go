...
type CapabilityServerDescriptor struct {
	...
	SupportedPolicies    []string `json:"SupportedPolicies,omitempty"`
...
// GetSupportedPolicies returns the SupportedPolicies field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CapabilityServerDescriptor) GetSupportedPolicies() []string {
	if o == nil {
		var ret []string
		return ret
	}
	return o.SupportedPolicies
}

// GetSupportedPoliciesOk returns a tuple with the SupportedPolicies field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CapabilityServerDescriptor) GetSupportedPoliciesOk() ([]string, bool) {
	if o == nil || IsNil(o.SupportedPolicies) {
		return nil, false
	}
	return o.SupportedPolicies, true
}
...
// SetSupportedPolicies gets a reference to the given []string and assigns it to the SupportedPolicies field.
func (o *CapabilityServerDescriptor) SetSupportedPolicies(v []string) {
	o.SupportedPolicies = v
}
...
func (o CapabilityServerDescriptor) ToMap() (map[string]interface{}, error) {
	...
	if o.SupportedPolicies != nil {
		toSerialize["SupportedPolicies"] = o.SupportedPolicies
	}
...
func (o *CapabilityServerDescriptor) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varCapabilityServerDescriptor.SupportedPolicies = varCapabilityServerDescriptorWithoutEmbeddedStruct.SupportedPolicies
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "SupportedPolicies")
