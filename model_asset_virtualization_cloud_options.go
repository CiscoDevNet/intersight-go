...
// checks if the AssetVirtualizationCloudOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetVirtualizationCloudOptions{}
...
// GetDefaultClassId returns the default value "asset.VirtualizationAmazonWebServiceOptions" of the ClassId field.
func (o *AssetVirtualizationCloudOptions) GetDefaultClassId() interface{} {
	return "asset.VirtualizationAmazonWebServiceOptions"
}
...
// GetDefaultObjectType returns the default value "asset.VirtualizationAmazonWebServiceOptions" of the ObjectType field.
func (o *AssetVirtualizationCloudOptions) GetDefaultObjectType() interface{} {
	return "asset.VirtualizationAmazonWebServiceOptions"
}
...
func (o *AssetVirtualizationCloudOptions) GetManagedRegionsOk() ([]MoMoRef, bool) {
	if o == nil || IsNil(o.ManagedRegions) {
		return nil, false
	}
...
func (o AssetVirtualizationCloudOptions) ToMap() (map[string]interface{}, error) {
...
func (o *AssetVirtualizationCloudOptions) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAssetVirtualizationCloudOptionsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAssetVirtualizationCloudOptions)
	if err == nil {
