...
// checks if the KubernetesBaseVirtualMachineInfraConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesBaseVirtualMachineInfraConfig{}
...
func (o *KubernetesBaseVirtualMachineInfraConfig) GetDefaultClassId() interface{} {
...
func (o *KubernetesBaseVirtualMachineInfraConfig) GetDefaultObjectType() interface{} {
	return "kubernetes.EsxiVirtualMachineInfraConfig"
}
...
func (o KubernetesBaseVirtualMachineInfraConfig) ToMap() (map[string]interface{}, error) {
...
func (o *KubernetesBaseVirtualMachineInfraConfig) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varKubernetesBaseVirtualMachineInfraConfigWithoutEmbeddedStruct)
	if err == nil {
		...
		varKubernetesBaseVirtualMachineInfraConfig.NetworkInterfaces = varKubernetesBaseVirtualMachineInfraConfigWithoutEmbeddedStruct.NetworkInterfaces
	...
	err = json.Unmarshal(data, &varKubernetesBaseVirtualMachineInfraConfig)
	if err == nil {
