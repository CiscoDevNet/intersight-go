...
type EquipmentChassis struct {
	...
	Operations []EquipmentChassisOperationsDetails `json:"Operations,omitempty"`
	// Bundle version which the XFM and PSU firmware belongs to.
...
func (o *EquipmentChassis) GetOperations() []EquipmentChassisOperationsDetails {
	if o == nil {
		var ret []EquipmentChassisOperationsDetails
		return ret
	}
	return o.Operations
}
...
// SetOperations gets a reference to the given []EquipmentChassisOperationsDetails and assigns it to the Operations field.
...
func (o *EquipmentChassis) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varEquipmentChassis.Operations = varEquipmentChassisWithoutEmbeddedStruct.Operations
		varEquipmentChassis.PackageVersion = varEquipmentChassisWithoutEmbeddedStruct.PackageVersion
		...
		varEquipmentChassis.PciNodes = varEquipmentChassisWithoutEmbeddedStruct.PciNodes
