...
// GetDefaultClassId returns the default value "hyperflex.AppSettingConstraint" of the ClassId field.
func (o *HyperflexAppSettingConstraint) GetDefaultClassId() interface{} {
	return "hyperflex.AppSettingConstraint"
}
...
// GetDefaultObjectType returns the default value "hyperflex.AppSettingConstraint" of the ObjectType field.
func (o *HyperflexAppSettingConstraint) GetDefaultObjectType() interface{} {
	return "hyperflex.AppSettingConstraint"
}
...
func (o *HyperflexAppSettingConstraint) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varHyperflexAppSettingConstraint.DeploymentType = varHyperflexAppSettingConstraintWithoutEmbeddedStruct.DeploymentType
