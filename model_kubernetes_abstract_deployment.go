...
// checks if the KubernetesAbstractDeployment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesAbstractDeployment{}
...
func (o KubernetesAbstractDeployment) ToMap() (map[string]interface{}, error) {
...
func (o *KubernetesAbstractDeployment) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varKubernetesAbstractDeploymentWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varKubernetesAbstractDeployment)
	if err == nil {
