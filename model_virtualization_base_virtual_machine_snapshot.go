...
func (o *VirtualizationBaseVirtualMachineSnapshot) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varVirtualizationBaseVirtualMachineSnapshotWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varVirtualizationBaseVirtualMachineSnapshot)
	if err == nil {
