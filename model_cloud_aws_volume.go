...
// checks if the CloudAwsVolume type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudAwsVolume{}
...
// GetDefaultClassId returns the default value "cloud.AwsVolume" of the ClassId field.
func (o *CloudAwsVolume) GetDefaultClassId() interface{} {
	return "cloud.AwsVolume"
}
...
// GetDefaultObjectType returns the default value "cloud.AwsVolume" of the ObjectType field.
func (o *CloudAwsVolume) GetDefaultObjectType() interface{} {
	return "cloud.AwsVolume"
}
...
func (o *CloudAwsVolume) SetAwsBillingUnitNil() {
...
func (o *CloudAwsVolume) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCloudAwsVolumeWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCloudAwsVolume)
	if err == nil {
