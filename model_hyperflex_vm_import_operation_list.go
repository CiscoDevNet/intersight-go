...
// checks if the HyperflexVmImportOperationList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexVmImportOperationList{}
...
func (o HyperflexVmImportOperationList) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexVmImportOperationList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexVmImportOperationListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexVmImportOperationList)
	if err == nil {
