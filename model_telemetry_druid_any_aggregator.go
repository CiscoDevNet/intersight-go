...
// checks if the TelemetryDruidAnyAggregator type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TelemetryDruidAnyAggregator{}
...
func (o TelemetryDruidAnyAggregator) ToMap() (map[string]interface{}, error) {
...
func (o *TelemetryDruidAnyAggregator) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTelemetryDruidAnyAggregator)
