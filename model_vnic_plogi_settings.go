...
// checks if the VnicPlogiSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VnicPlogiSettings{}
...
// GetDefaultClassId returns the default value "vnic.PlogiSettings" of the ClassId field.
func (o *VnicPlogiSettings) GetDefaultClassId() interface{} {
	return "vnic.PlogiSettings"
}
...
// GetDefaultObjectType returns the default value "vnic.PlogiSettings" of the ObjectType field.
func (o *VnicPlogiSettings) GetDefaultObjectType() interface{} {
	return "vnic.PlogiSettings"
}
...
func (o VnicPlogiSettings) ToMap() (map[string]interface{}, error) {
...
func (o *VnicPlogiSettings) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVnicPlogiSettingsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVnicPlogiSettings)
	if err == nil {
