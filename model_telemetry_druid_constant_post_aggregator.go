...
// checks if the TelemetryDruidConstantPostAggregator type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TelemetryDruidConstantPostAggregator{}
...
func (o TelemetryDruidConstantPostAggregator) ToMap() (map[string]interface{}, error) {
...
func (o *TelemetryDruidConstantPostAggregator) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTelemetryDruidConstantPostAggregator)
