...
type PolicyAbstractConfigProfile struct {
	...
	PartiallyDeployedPolicies []PolicyPolicyContextHolder    `json:"PartiallyDeployedPolicies,omitempty"`
...
// GetPartiallyDeployedPolicies returns the PartiallyDeployedPolicies field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PolicyAbstractConfigProfile) GetPartiallyDeployedPolicies() []PolicyPolicyContextHolder {
	if o == nil {
		var ret []PolicyPolicyContextHolder
		return ret
	}
	return o.PartiallyDeployedPolicies
}

// GetPartiallyDeployedPoliciesOk returns a tuple with the PartiallyDeployedPolicies field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PolicyAbstractConfigProfile) GetPartiallyDeployedPoliciesOk() ([]PolicyPolicyContextHolder, bool) {
	if o == nil || IsNil(o.PartiallyDeployedPolicies) {
		return nil, false
	}
	return o.PartiallyDeployedPolicies, true
}
...
// SetPartiallyDeployedPolicies gets a reference to the given []PolicyPolicyContextHolder and assigns it to the PartiallyDeployedPolicies field.
func (o *PolicyAbstractConfigProfile) SetPartiallyDeployedPolicies(v []PolicyPolicyContextHolder) {
	o.PartiallyDeployedPolicies = v
}
...
func (o PolicyAbstractConfigProfile) ToMap() (map[string]interface{}, error) {
	...
	if o.PartiallyDeployedPolicies != nil {
		toSerialize["PartiallyDeployedPolicies"] = o.PartiallyDeployedPolicies
	}
...
func (o *PolicyAbstractConfigProfile) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varPolicyAbstractConfigProfile.PartiallyDeployedPolicies = varPolicyAbstractConfigProfileWithoutEmbeddedStruct.PartiallyDeployedPolicies
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "PartiallyDeployedPolicies")
