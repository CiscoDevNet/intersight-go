...
// checks if the VnicEthVnicInventoryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VnicEthVnicInventoryList{}
...
func (o VnicEthVnicInventoryList) ToMap() (map[string]interface{}, error) {
...
func (o *VnicEthVnicInventoryList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVnicEthVnicInventoryListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVnicEthVnicInventoryList)
	if err == nil {
