...
// ResourcepoolPoolListAllOf struct for ResourcepoolPoolListAllOf
type ResourcepoolPoolListAllOf struct {
...
type _ResourcepoolPoolListAllOf ResourcepoolPoolListAllOf
...
func NewResourcepoolPoolListAllOf() *ResourcepoolPoolListAllOf {
	this := ResourcepoolPoolListAllOf{}
	return &this
}
...
func (o ResourcepoolPoolListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ResourcepoolPoolListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varResourcepoolPoolListAllOf := _ResourcepoolPoolListAllOf{}

	if err = json.Unmarshal(bytes, &varResourcepoolPoolListAllOf); err == nil {
		*o = ResourcepoolPoolListAllOf(varResourcepoolPoolListAllOf)
	}
...
type NullableResourcepoolPoolListAllOf struct {
	value *ResourcepoolPoolListAllOf
	isSet bool
}

func (v NullableResourcepoolPoolListAllOf) Get() *ResourcepoolPoolListAllOf {
	return v.value
}

func (v *NullableResourcepoolPoolListAllOf) Set(val *ResourcepoolPoolListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableResourcepoolPoolListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableResourcepoolPoolListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourcepoolPoolListAllOf(val *ResourcepoolPoolListAllOf) *NullableResourcepoolPoolListAllOf {
	return &NullableResourcepoolPoolListAllOf{value: val, isSet: true}
}

func (v NullableResourcepoolPoolListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourcepoolPoolListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
