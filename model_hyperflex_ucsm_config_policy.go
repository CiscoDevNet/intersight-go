...
// checks if the HyperflexUcsmConfigPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexUcsmConfigPolicy{}
...
type HyperflexUcsmConfigPolicy struct {
	...
	ServerFirmwareVersion *string `json:"ServerFirmwareVersion,omitempty" validate:"regexp=(^3\\\\.[1-9]\\\\([1-9][a-z]\\\\)$|^[4-9]\\\\.[0-9]\\\\([1-9][a-z]\\\\)$)"`
...
// GetDefaultClassId returns the default value "hyperflex.UcsmConfigPolicy" of the ClassId field.
func (o *HyperflexUcsmConfigPolicy) GetDefaultClassId() interface{} {
	return "hyperflex.UcsmConfigPolicy"
}
...
// GetDefaultObjectType returns the default value "hyperflex.UcsmConfigPolicy" of the ObjectType field.
func (o *HyperflexUcsmConfigPolicy) GetDefaultObjectType() interface{} {
	return "hyperflex.UcsmConfigPolicy"
}
...
func (o *HyperflexUcsmConfigPolicy) SetOrganizationNil() {
	o.Organization.Set(nil)
}

// UnsetOrganization ensures that no value is present for Organization, not even an explicit nil
func (o *HyperflexUcsmConfigPolicy) UnsetOrganization() {
...
func (o HyperflexUcsmConfigPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexUcsmConfigPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexUcsmConfigPolicyWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexUcsmConfigPolicy)
	if err == nil {
