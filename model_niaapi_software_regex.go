...
// checks if the NiaapiSoftwareRegex type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiaapiSoftwareRegex{}
...
// GetDefaultClassId returns the default value "niaapi.SoftwareRegex" of the ClassId field.
func (o *NiaapiSoftwareRegex) GetDefaultClassId() interface{} {
	return "niaapi.SoftwareRegex"
}
...
// GetDefaultObjectType returns the default value "niaapi.SoftwareRegex" of the ObjectType field.
func (o *NiaapiSoftwareRegex) GetDefaultObjectType() interface{} {
	return "niaapi.SoftwareRegex"
}
...
func (o NiaapiSoftwareRegex) ToMap() (map[string]interface{}, error) {
...
func (o *NiaapiSoftwareRegex) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiaapiSoftwareRegexWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiaapiSoftwareRegex)
	if err == nil {
