...
func (o *NiatelemetryApicDbgexpRsExportDest) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varNiatelemetryApicDbgexpRsExportDestWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varNiatelemetryApicDbgexpRsExportDest)
	if err == nil {
