...
func (o *NiatelemetryApicFexDetails) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varNiatelemetryApicFexDetailsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varNiatelemetryApicFexDetails)
	if err == nil {
