...
// checks if the NiatelemetryApicFexDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiatelemetryApicFexDetails{}

// NiatelemetryApicFexDetails Object to capture FEX details in APIC.
type NiatelemetryApicFexDetails struct {
	MoBaseMo
...
type _NiatelemetryApicFexDetails NiatelemetryApicFexDetails
...
func NewNiatelemetryApicFexDetails(classId string, objectType string) *NiatelemetryApicFexDetails {
	this := NiatelemetryApicFexDetails{}
...
// GetDefaultClassId returns the default value "niatelemetry.ApicFexDetails" of the ClassId field.
func (o *NiatelemetryApicFexDetails) GetDefaultClassId() interface{} {
	return "niatelemetry.ApicFexDetails"
}
...
// GetDefaultObjectType returns the default value "niatelemetry.ApicFexDetails" of the ObjectType field.
func (o *NiatelemetryApicFexDetails) GetDefaultObjectType() interface{} {
	return "niatelemetry.ApicFexDetails"
}
...
func (o *NiatelemetryApicFexDetails) SetRegisteredDeviceNil() {
...
func (o NiatelemetryApicFexDetails) MarshalJSON() ([]byte, error) {
...
func (o NiatelemetryApicFexDetails) ToMap() (map[string]interface{}, error) {
...
func (o *NiatelemetryApicFexDetails) UnmarshalJSON(data []byte) (err error) {
	...
	type NiatelemetryApicFexDetailsWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
		ObjectType string `json:"ObjectType"`
	...
	varNiatelemetryApicFexDetailsWithoutEmbeddedStruct := NiatelemetryApicFexDetailsWithoutEmbeddedStruct{}

	err = json.Unmarshal(data, &varNiatelemetryApicFexDetailsWithoutEmbeddedStruct)
	if err == nil {
		varNiatelemetryApicFexDetails := _NiatelemetryApicFexDetails{}
		varNiatelemetryApicFexDetails.ClassId = varNiatelemetryApicFexDetailsWithoutEmbeddedStruct.ClassId
		varNiatelemetryApicFexDetails.ObjectType = varNiatelemetryApicFexDetailsWithoutEmbeddedStruct.ObjectType
		varNiatelemetryApicFexDetails.Dn = varNiatelemetryApicFexDetailsWithoutEmbeddedStruct.Dn
		varNiatelemetryApicFexDetails.ModelNumber = varNiatelemetryApicFexDetailsWithoutEmbeddedStruct.ModelNumber
		varNiatelemetryApicFexDetails.NodeId = varNiatelemetryApicFexDetailsWithoutEmbeddedStruct.NodeId
		varNiatelemetryApicFexDetails.RecordType = varNiatelemetryApicFexDetailsWithoutEmbeddedStruct.RecordType
		varNiatelemetryApicFexDetails.RecordVersion = varNiatelemetryApicFexDetailsWithoutEmbeddedStruct.RecordVersion
		varNiatelemetryApicFexDetails.SerialNumber = varNiatelemetryApicFexDetailsWithoutEmbeddedStruct.SerialNumber
		varNiatelemetryApicFexDetails.SiteName = varNiatelemetryApicFexDetailsWithoutEmbeddedStruct.SiteName
		varNiatelemetryApicFexDetails.VendorName = varNiatelemetryApicFexDetailsWithoutEmbeddedStruct.VendorName
		varNiatelemetryApicFexDetails.Vid = varNiatelemetryApicFexDetailsWithoutEmbeddedStruct.Vid
		varNiatelemetryApicFexDetails.RegisteredDevice = varNiatelemetryApicFexDetailsWithoutEmbeddedStruct.RegisteredDevice
		*o = NiatelemetryApicFexDetails(varNiatelemetryApicFexDetails)
	} else {
		return err
	}
	...
	err = json.Unmarshal(data, &varNiatelemetryApicFexDetails)
	if err == nil {
		o.MoBaseMo = varNiatelemetryApicFexDetails.MoBaseMo
	} else {
		return err
	}
...
type NullableNiatelemetryApicFexDetails struct {
	value *NiatelemetryApicFexDetails
	isSet bool
}

func (v NullableNiatelemetryApicFexDetails) Get() *NiatelemetryApicFexDetails {
	return v.value
}

func (v *NullableNiatelemetryApicFexDetails) Set(val *NiatelemetryApicFexDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetryApicFexDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetryApicFexDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetryApicFexDetails(val *NiatelemetryApicFexDetails) *NullableNiatelemetryApicFexDetails {
	return &NullableNiatelemetryApicFexDetails{value: val, isSet: true}
}

func (v NullableNiatelemetryApicFexDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetryApicFexDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
