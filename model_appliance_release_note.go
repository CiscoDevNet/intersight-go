...
// checks if the ApplianceReleaseNote type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplianceReleaseNote{}
...
// GetDefaultClassId returns the default value "appliance.ReleaseNote" of the ClassId field.
func (o *ApplianceReleaseNote) GetDefaultClassId() interface{} {
	return "appliance.ReleaseNote"
}
...
// GetDefaultObjectType returns the default value "appliance.ReleaseNote" of the ObjectType field.
func (o *ApplianceReleaseNote) GetDefaultObjectType() interface{} {
	return "appliance.ReleaseNote"
}
...
func (o ApplianceReleaseNote) ToMap() (map[string]interface{}, error) {
...
func (o *ApplianceReleaseNote) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varApplianceReleaseNoteWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varApplianceReleaseNote)
	if err == nil {
