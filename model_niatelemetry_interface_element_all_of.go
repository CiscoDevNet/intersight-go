...
// NiatelemetryInterfaceElementAllOf Definition of the list of properties defined in 'niatelemetry.InterfaceElement', excluding properties defined in parent classes.
type NiatelemetryInterfaceElementAllOf struct {
...
type _NiatelemetryInterfaceElementAllOf NiatelemetryInterfaceElementAllOf
...
func NewNiatelemetryInterfaceElementAllOf(classId string, objectType string) *NiatelemetryInterfaceElementAllOf {
	this := NiatelemetryInterfaceElementAllOf{}
...
func (o NiatelemetryInterfaceElementAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetryInterfaceElementAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetryInterfaceElementAllOf := _NiatelemetryInterfaceElementAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetryInterfaceElementAllOf); err == nil {
		*o = NiatelemetryInterfaceElementAllOf(varNiatelemetryInterfaceElementAllOf)
	}
...
type NullableNiatelemetryInterfaceElementAllOf struct {
	value *NiatelemetryInterfaceElementAllOf
	isSet bool
}

func (v NullableNiatelemetryInterfaceElementAllOf) Get() *NiatelemetryInterfaceElementAllOf {
	return v.value
}

func (v *NullableNiatelemetryInterfaceElementAllOf) Set(val *NiatelemetryInterfaceElementAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetryInterfaceElementAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetryInterfaceElementAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetryInterfaceElementAllOf(val *NiatelemetryInterfaceElementAllOf) *NullableNiatelemetryInterfaceElementAllOf {
	return &NullableNiatelemetryInterfaceElementAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetryInterfaceElementAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetryInterfaceElementAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
