...
// checks if the HyperflexHxZoneInfoDt type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexHxZoneInfoDt{}
...
// GetDefaultClassId returns the default value "hyperflex.HxZoneInfoDt" of the ClassId field.
func (o *HyperflexHxZoneInfoDt) GetDefaultClassId() interface{} {
	return "hyperflex.HxZoneInfoDt"
}
...
// GetDefaultObjectType returns the default value "hyperflex.HxZoneInfoDt" of the ObjectType field.
func (o *HyperflexHxZoneInfoDt) GetDefaultObjectType() interface{} {
	return "hyperflex.HxZoneInfoDt"
}
...
func (o HyperflexHxZoneInfoDt) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexHxZoneInfoDt) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexHxZoneInfoDtWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexHxZoneInfoDt)
	if err == nil {
