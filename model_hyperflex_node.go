...
// checks if the HyperflexNode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexNode{}
...
// GetDefaultClassId returns the default value "hyperflex.Node" of the ClassId field.
func (o *HyperflexNode) GetDefaultClassId() interface{} {
	return "hyperflex.Node"
}
...
// GetDefaultObjectType returns the default value "hyperflex.Node" of the ObjectType field.
func (o *HyperflexNode) GetDefaultObjectType() interface{} {
	return "hyperflex.Node"
}
...
func (o *HyperflexNode) GetEmptySlotsListOk() ([]string, bool) {
	if o == nil || IsNil(o.EmptySlotsList) {
		return nil, false
	}
...
func (o *HyperflexNode) GetHxdpDataIp() HyperflexHxNetworkAddressDt {
	if o == nil || IsNil(o.HxdpDataIp.Get()) {
...
func (o *HyperflexNode) GetHxdpMmgtIp() HyperflexHxNetworkAddressDt {
	if o == nil || IsNil(o.HxdpMmgtIp.Get()) {
		var ret HyperflexHxNetworkAddressDt
		return ret
	}
...
func (o *HyperflexNode) GetHypervisorDataIp() HyperflexHxNetworkAddressDt {
	if o == nil || IsNil(o.HypervisorDataIp.Get()) {
		var ret HyperflexHxNetworkAddressDt
		return ret
	}
...
func (o *HyperflexNode) GetNodeMaintenanceMode() string {
	if o == nil || IsNil(o.NodeMaintenanceMode) {
		var ret string
		return ret
	}
...
func (o *HyperflexNode) SetSiteInfoNil() {
	o.SiteInfo.Set(nil)
}
...
func (o *HyperflexNode) SetClusterNil() {
	o.Cluster.Set(nil)
}
...
func (o *HyperflexNode) SetClusterMemberNil() {
...
func (o *HyperflexNode) SetPhysicalServerNil() {
...
func (o HyperflexNode) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NodeMaintenanceMode) {
...
func (o *HyperflexNode) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexNodeWithoutEmbeddedStruct)
	if err == nil {
		...
		varHyperflexNode.EmptySlotsList = varHyperflexNodeWithoutEmbeddedStruct.EmptySlotsList
		varHyperflexNode.HostName = varHyperflexNodeWithoutEmbeddedStruct.HostName
		varHyperflexNode.HxdpDataIp = varHyperflexNodeWithoutEmbeddedStruct.HxdpDataIp
		varHyperflexNode.HxdpMmgtIp = varHyperflexNodeWithoutEmbeddedStruct.HxdpMmgtIp
		varHyperflexNode.Hypervisor = varHyperflexNodeWithoutEmbeddedStruct.Hypervisor
		varHyperflexNode.HypervisorDataIp = varHyperflexNodeWithoutEmbeddedStruct.HypervisorDataIp
		...
		varHyperflexNode.NodeMaintenanceMode = varHyperflexNodeWithoutEmbeddedStruct.NodeMaintenanceMode
		varHyperflexNode.NodeStatus = varHyperflexNodeWithoutEmbeddedStruct.NodeStatus
		varHyperflexNode.NodeUuid = varHyperflexNodeWithoutEmbeddedStruct.NodeUuid
		...
		varHyperflexNode.SiteInfo = varHyperflexNodeWithoutEmbeddedStruct.SiteInfo
		...
		varHyperflexNode.Drives = varHyperflexNodeWithoutEmbeddedStruct.Drives
	...
	err = json.Unmarshal(data, &varHyperflexNode)
	if err == nil {
