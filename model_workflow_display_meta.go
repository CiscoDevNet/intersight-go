...
// checks if the WorkflowDisplayMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowDisplayMeta{}
...
// GetDefaultClassId returns the default value "workflow.DisplayMeta" of the ClassId field.
func (o *WorkflowDisplayMeta) GetDefaultClassId() interface{} {
	return "workflow.DisplayMeta"
}
...
// GetDefaultObjectType returns the default value "workflow.DisplayMeta" of the ObjectType field.
func (o *WorkflowDisplayMeta) GetDefaultObjectType() interface{} {
	return "workflow.DisplayMeta"
}
...
func (o WorkflowDisplayMeta) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowDisplayMeta) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowDisplayMetaWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowDisplayMeta)
	if err == nil {
