...
// checks if the CloudSkuDatabaseTypeList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudSkuDatabaseTypeList{}
...
func (o CloudSkuDatabaseTypeList) ToMap() (map[string]interface{}, error) {
...
func (o *CloudSkuDatabaseTypeList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCloudSkuDatabaseTypeListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCloudSkuDatabaseTypeList)
	if err == nil {
