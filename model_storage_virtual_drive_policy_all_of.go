...
// StorageVirtualDrivePolicyAllOf Definition of the list of properties defined in 'storage.VirtualDrivePolicy', excluding properties defined in parent classes.
type StorageVirtualDrivePolicyAllOf struct {
...
type _StorageVirtualDrivePolicyAllOf StorageVirtualDrivePolicyAllOf
...
func NewStorageVirtualDrivePolicyAllOf(classId string, objectType string) *StorageVirtualDrivePolicyAllOf {
	this := StorageVirtualDrivePolicyAllOf{}
...
// and a boolean to check if the value has been set.
func (o *StorageVirtualDrivePolicyAllOf) GetAccessPolicyOk() (*string, bool) {
	if o == nil || o.AccessPolicy == nil {
		return nil, false
	}
...
func (o *StorageVirtualDrivePolicyAllOf) SetReadPolicy(v string) {
	o.ReadPolicy = &v
}
...
func (o StorageVirtualDrivePolicyAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageVirtualDrivePolicyAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageVirtualDrivePolicyAllOf := _StorageVirtualDrivePolicyAllOf{}

	if err = json.Unmarshal(bytes, &varStorageVirtualDrivePolicyAllOf); err == nil {
		*o = StorageVirtualDrivePolicyAllOf(varStorageVirtualDrivePolicyAllOf)
	}
...
type NullableStorageVirtualDrivePolicyAllOf struct {
	value *StorageVirtualDrivePolicyAllOf
	isSet bool
}

func (v NullableStorageVirtualDrivePolicyAllOf) Get() *StorageVirtualDrivePolicyAllOf {
	return v.value
}

func (v *NullableStorageVirtualDrivePolicyAllOf) Set(val *StorageVirtualDrivePolicyAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageVirtualDrivePolicyAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageVirtualDrivePolicyAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageVirtualDrivePolicyAllOf(val *StorageVirtualDrivePolicyAllOf) *NullableStorageVirtualDrivePolicyAllOf {
	return &NullableStorageVirtualDrivePolicyAllOf{value: val, isSet: true}
}

func (v NullableStorageVirtualDrivePolicyAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageVirtualDrivePolicyAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
