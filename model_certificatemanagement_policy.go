...
func (o *CertificatemanagementPolicy) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCertificatemanagementPolicyWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varCertificatemanagementPolicy)
	if err == nil {
