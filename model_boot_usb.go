...
// checks if the BootUsb type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BootUsb{}
...
// GetDefaultClassId returns the default value "boot.Usb" of the ClassId field.
func (o *BootUsb) GetDefaultClassId() interface{} {
	return "boot.Usb"
}
...
// GetDefaultObjectType returns the default value "boot.Usb" of the ObjectType field.
func (o *BootUsb) GetDefaultObjectType() interface{} {
	return "boot.Usb"
}
...
func (o BootUsb) ToMap() (map[string]interface{}, error) {
...
func (o *BootUsb) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varBootUsbWithoutEmbeddedStruct)
	if err == nil {
		varBootUsb := _BootUsb{}
	...
	err = json.Unmarshal(data, &varBootUsb)
	if err == nil {
