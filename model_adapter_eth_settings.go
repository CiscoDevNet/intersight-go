...
// checks if the AdapterEthSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdapterEthSettings{}
...
// GetDefaultClassId returns the default value "adapter.EthSettings" of the ClassId field.
func (o *AdapterEthSettings) GetDefaultClassId() interface{} {
	return "adapter.EthSettings"
}
...
// GetDefaultObjectType returns the default value "adapter.EthSettings" of the ObjectType field.
func (o *AdapterEthSettings) GetDefaultObjectType() interface{} {
	return "adapter.EthSettings"
}
...
func (o AdapterEthSettings) ToMap() (map[string]interface{}, error) {
...
func (o *AdapterEthSettings) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAdapterEthSettingsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAdapterEthSettings)
	if err == nil {
