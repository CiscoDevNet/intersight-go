...
// checks if the VirtualizationEsxiVmComputeConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualizationEsxiVmComputeConfiguration{}
...
// GetDefaultClassId returns the default value "virtualization.EsxiVmComputeConfiguration" of the ClassId field.
func (o *VirtualizationEsxiVmComputeConfiguration) GetDefaultClassId() interface{} {
	return "virtualization.EsxiVmComputeConfiguration"
}
...
// GetDefaultObjectType returns the default value "virtualization.EsxiVmComputeConfiguration" of the ObjectType field.
func (o *VirtualizationEsxiVmComputeConfiguration) GetDefaultObjectType() interface{} {
	return "virtualization.EsxiVmComputeConfiguration"
}
...
func (o VirtualizationEsxiVmComputeConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualizationEsxiVmComputeConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVirtualizationEsxiVmComputeConfigurationWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVirtualizationEsxiVmComputeConfiguration)
	if err == nil {
