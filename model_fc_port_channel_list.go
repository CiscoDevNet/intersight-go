...
// checks if the FcPortChannelList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FcPortChannelList{}
...
func (o FcPortChannelList) ToMap() (map[string]interface{}, error) {
...
func (o *FcPortChannelList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFcPortChannelListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFcPortChannelList)
	if err == nil {
