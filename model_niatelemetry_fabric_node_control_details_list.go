...
// checks if the NiatelemetryFabricNodeControlDetailsList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiatelemetryFabricNodeControlDetailsList{}
...
func (o NiatelemetryFabricNodeControlDetailsList) ToMap() (map[string]interface{}, error) {
...
func (o *NiatelemetryFabricNodeControlDetailsList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiatelemetryFabricNodeControlDetailsListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiatelemetryFabricNodeControlDetailsList)
	if err == nil {
