...
// StorageDriveSecurityPolicyListAllOf struct for StorageDriveSecurityPolicyListAllOf
type StorageDriveSecurityPolicyListAllOf struct {
...
type _StorageDriveSecurityPolicyListAllOf StorageDriveSecurityPolicyListAllOf
...
func NewStorageDriveSecurityPolicyListAllOf() *StorageDriveSecurityPolicyListAllOf {
	this := StorageDriveSecurityPolicyListAllOf{}
	return &this
}
...
func (o StorageDriveSecurityPolicyListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageDriveSecurityPolicyListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageDriveSecurityPolicyListAllOf := _StorageDriveSecurityPolicyListAllOf{}

	if err = json.Unmarshal(bytes, &varStorageDriveSecurityPolicyListAllOf); err == nil {
		*o = StorageDriveSecurityPolicyListAllOf(varStorageDriveSecurityPolicyListAllOf)
	}
...
type NullableStorageDriveSecurityPolicyListAllOf struct {
	value *StorageDriveSecurityPolicyListAllOf
	isSet bool
}

func (v NullableStorageDriveSecurityPolicyListAllOf) Get() *StorageDriveSecurityPolicyListAllOf {
	return v.value
}

func (v *NullableStorageDriveSecurityPolicyListAllOf) Set(val *StorageDriveSecurityPolicyListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageDriveSecurityPolicyListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageDriveSecurityPolicyListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageDriveSecurityPolicyListAllOf(val *StorageDriveSecurityPolicyListAllOf) *NullableStorageDriveSecurityPolicyListAllOf {
	return &NullableStorageDriveSecurityPolicyListAllOf{value: val, isSet: true}
}

func (v NullableStorageDriveSecurityPolicyListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageDriveSecurityPolicyListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
