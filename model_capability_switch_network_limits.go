...
type CapabilitySwitchNetworkLimits struct {
	...
	MaximumSecureRouterPorts *int64 `json:"MaximumSecureRouterPorts,omitempty"`
...
// GetMaximumSecureRouterPorts returns the MaximumSecureRouterPorts field value if set, zero value otherwise.
func (o *CapabilitySwitchNetworkLimits) GetMaximumSecureRouterPorts() int64 {
	if o == nil || IsNil(o.MaximumSecureRouterPorts) {
		var ret int64
		return ret
	}
	return *o.MaximumSecureRouterPorts
}

// GetMaximumSecureRouterPortsOk returns a tuple with the MaximumSecureRouterPorts field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CapabilitySwitchNetworkLimits) GetMaximumSecureRouterPortsOk() (*int64, bool) {
	if o == nil || IsNil(o.MaximumSecureRouterPorts) {
		return nil, false
	}
	return o.MaximumSecureRouterPorts, true
}
...
// SetMaximumSecureRouterPorts gets a reference to the given int64 and assigns it to the MaximumSecureRouterPorts field.
func (o *CapabilitySwitchNetworkLimits) SetMaximumSecureRouterPorts(v int64) {
	o.MaximumSecureRouterPorts = &v
}
...
func (o CapabilitySwitchNetworkLimits) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MaximumSecureRouterPorts) {
		toSerialize["MaximumSecureRouterPorts"] = o.MaximumSecureRouterPorts
	}
...
func (o *CapabilitySwitchNetworkLimits) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varCapabilitySwitchNetworkLimits.MaximumSecureRouterPorts = varCapabilitySwitchNetworkLimitsWithoutEmbeddedStruct.MaximumSecureRouterPorts
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "MaximumSecureRouterPorts")
