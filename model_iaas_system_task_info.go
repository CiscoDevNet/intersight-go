...
// IaasSystemTaskInfo The SystemTaskInfo object provides details about library task executions within UCS Director (UCSD), supporting system oversight and process management.   #### Purpose SystemTaskInfo documents task execution data, aiding in workflow task management and optimization strategies.  #### Key Concepts  - **Execution Frequency:** Tracks each library tasks execution count, supporting process refinement and optimization. - **Functional Categorization:** Provides information regarding the task category to which the library task belongs in UCSD.  - **Read-Only Access:** Ensures secure access to system task data without modification.
