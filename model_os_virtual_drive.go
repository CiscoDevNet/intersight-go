...
// checks if the OsVirtualDrive type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OsVirtualDrive{}
...
// GetDefaultClassId returns the default value "os.VirtualDrive" of the ClassId field.
func (o *OsVirtualDrive) GetDefaultClassId() interface{} {
	return "os.VirtualDrive"
}
...
// GetDefaultObjectType returns the default value "os.VirtualDrive" of the ObjectType field.
func (o *OsVirtualDrive) GetDefaultObjectType() interface{} {
	return "os.VirtualDrive"
}
...
func (o OsVirtualDrive) ToMap() (map[string]interface{}, error) {
...
func (o *OsVirtualDrive) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varOsVirtualDriveWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varOsVirtualDrive)
	if err == nil {
