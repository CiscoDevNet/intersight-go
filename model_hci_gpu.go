...
// HciGpu A GPU belonging to a node in a Nutanix cluster. #### Purpose The Gpu object provides a detailed view of GPU configuration for a node in a Nutanix cluster. #### Key Concepts - **Configuration Details:** Offers insights into GPU attributes like model, associated node and cluster, and allocation of virtual GPUs.
type HciGpu struct {
	MoBaseMo
