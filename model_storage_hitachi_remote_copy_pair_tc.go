...
// checks if the StorageHitachiRemoteCopyPairTc type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageHitachiRemoteCopyPairTc{}

// StorageHitachiRemoteCopyPairTc The HitachiRemoteCopyPairTc object represents a TrueCopy pair entity within the Hitachi storage array, focused on replication management and operations. #### Purpose HitachiRemoteCopyPairTc is designed to manage TrueCopy pairs, facilitating replication operations and monitoring of pair attributes. #### Key Concepts - **Replication Operations:** Manages replication types, LDEV numbers, and status information for TrueCopy pairs. - **Privilege Sets:** Provides controlled access for managing TrueCopy pair settings with defined privilege sets. - **Licensing:** Supports operations under specified entitlements, adhering to licensing requirements.
type StorageHitachiRemoteCopyPairTc struct {
	MoBaseMo
...
type _StorageHitachiRemoteCopyPairTc StorageHitachiRemoteCopyPairTc
...
func NewStorageHitachiRemoteCopyPairTc(classId string, objectType string) *StorageHitachiRemoteCopyPairTc {
	this := StorageHitachiRemoteCopyPairTc{}
...
func NewStorageHitachiRemoteCopyPairTcWithDefaults() *StorageHitachiRemoteCopyPairTc {
	this := StorageHitachiRemoteCopyPairTc{}
	var classId string = "storage.HitachiRemoteCopyPairTc"
	this.ClassId = classId
	var objectType string = "storage.HitachiRemoteCopyPairTc"
	this.ObjectType = objectType
	return &this
}
...
// GetDefaultClassId returns the default value "storage.HitachiRemoteCopyPairTc" of the ClassId field.
func (o *StorageHitachiRemoteCopyPairTc) GetDefaultClassId() interface{} {
	return "storage.HitachiRemoteCopyPairTc"
}
...
// GetDefaultObjectType returns the default value "storage.HitachiRemoteCopyPairTc" of the ObjectType field.
func (o *StorageHitachiRemoteCopyPairTc) GetDefaultObjectType() interface{} {
	return "storage.HitachiRemoteCopyPairTc"
}
...
func (o *StorageHitachiRemoteCopyPairTc) SetArrayNil() {
	o.Array.Set(nil)
}
...
func (o *StorageHitachiRemoteCopyPairTc) SetRegisteredDeviceNil() {
...
func (o StorageHitachiRemoteCopyPairTc) MarshalJSON() ([]byte, error) {
...
func (o StorageHitachiRemoteCopyPairTc) ToMap() (map[string]interface{}, error) {
...
func (o *StorageHitachiRemoteCopyPairTc) UnmarshalJSON(data []byte) (err error) {
	...
	type StorageHitachiRemoteCopyPairTcWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
		ObjectType string `json:"ObjectType"`
	...
	varStorageHitachiRemoteCopyPairTcWithoutEmbeddedStruct := StorageHitachiRemoteCopyPairTcWithoutEmbeddedStruct{}

	err = json.Unmarshal(data, &varStorageHitachiRemoteCopyPairTcWithoutEmbeddedStruct)
	if err == nil {
		varStorageHitachiRemoteCopyPairTc := _StorageHitachiRemoteCopyPairTc{}
		varStorageHitachiRemoteCopyPairTc.ClassId = varStorageHitachiRemoteCopyPairTcWithoutEmbeddedStruct.ClassId
		varStorageHitachiRemoteCopyPairTc.ObjectType = varStorageHitachiRemoteCopyPairTcWithoutEmbeddedStruct.ObjectType
		varStorageHitachiRemoteCopyPairTc.MuNumber = varStorageHitachiRemoteCopyPairTcWithoutEmbeddedStruct.MuNumber
		varStorageHitachiRemoteCopyPairTc.Name = varStorageHitachiRemoteCopyPairTcWithoutEmbeddedStruct.Name
		varStorageHitachiRemoteCopyPairTc.PvolLdevId = varStorageHitachiRemoteCopyPairTcWithoutEmbeddedStruct.PvolLdevId
		varStorageHitachiRemoteCopyPairTc.PvolStorageSerial = varStorageHitachiRemoteCopyPairTcWithoutEmbeddedStruct.PvolStorageSerial
		varStorageHitachiRemoteCopyPairTc.ReplicationType = varStorageHitachiRemoteCopyPairTcWithoutEmbeddedStruct.ReplicationType
		varStorageHitachiRemoteCopyPairTc.Status = varStorageHitachiRemoteCopyPairTcWithoutEmbeddedStruct.Status
		varStorageHitachiRemoteCopyPairTc.SvolLdevId = varStorageHitachiRemoteCopyPairTcWithoutEmbeddedStruct.SvolLdevId
		varStorageHitachiRemoteCopyPairTc.SvolStorageSerial = varStorageHitachiRemoteCopyPairTcWithoutEmbeddedStruct.SvolStorageSerial
		varStorageHitachiRemoteCopyPairTc.Array = varStorageHitachiRemoteCopyPairTcWithoutEmbeddedStruct.Array
		varStorageHitachiRemoteCopyPairTc.RegisteredDevice = varStorageHitachiRemoteCopyPairTcWithoutEmbeddedStruct.RegisteredDevice
		*o = StorageHitachiRemoteCopyPairTc(varStorageHitachiRemoteCopyPairTc)
	} else {
		return err
	}
	...
	err = json.Unmarshal(data, &varStorageHitachiRemoteCopyPairTc)
	if err == nil {
		o.MoBaseMo = varStorageHitachiRemoteCopyPairTc.MoBaseMo
	} else {
		return err
	}
...
type NullableStorageHitachiRemoteCopyPairTc struct {
	value *StorageHitachiRemoteCopyPairTc
	isSet bool
}

func (v NullableStorageHitachiRemoteCopyPairTc) Get() *StorageHitachiRemoteCopyPairTc {
	return v.value
}

func (v *NullableStorageHitachiRemoteCopyPairTc) Set(val *StorageHitachiRemoteCopyPairTc) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageHitachiRemoteCopyPairTc) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageHitachiRemoteCopyPairTc) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageHitachiRemoteCopyPairTc(val *StorageHitachiRemoteCopyPairTc) *NullableStorageHitachiRemoteCopyPairTc {
	return &NullableStorageHitachiRemoteCopyPairTc{value: val, isSet: true}
}

func (v NullableStorageHitachiRemoteCopyPairTc) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageHitachiRemoteCopyPairTc) UnmarshalJSON(src []byte) error {
	v.isSet = true
