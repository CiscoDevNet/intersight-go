...
// checks if the SoftwarerepositoryCatalog type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SoftwarerepositoryCatalog{}
...
// GetDefaultClassId returns the default value "softwarerepository.Catalog" of the ClassId field.
func (o *SoftwarerepositoryCatalog) GetDefaultClassId() interface{} {
	return "softwarerepository.Catalog"
}
...
// GetDefaultObjectType returns the default value "softwarerepository.Catalog" of the ObjectType field.
func (o *SoftwarerepositoryCatalog) GetDefaultObjectType() interface{} {
	return "softwarerepository.Catalog"
}
...
func (o *SoftwarerepositoryCatalog) GetIsImagePullFailure() bool {
	if o == nil || IsNil(o.IsImagePullFailure) {
		var ret bool
		return ret
	}
...
func (o *SoftwarerepositoryCatalog) SetOrganizationNil() {
...
func (o *SoftwarerepositoryCatalog) SetSystemNil() {
	o.System.Set(nil)
}
...
func (o SoftwarerepositoryCatalog) ToMap() (map[string]interface{}, error) {
...
func (o *SoftwarerepositoryCatalog) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSoftwarerepositoryCatalogWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varSoftwarerepositoryCatalog)
	if err == nil {
