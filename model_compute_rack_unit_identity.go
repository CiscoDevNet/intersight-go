...
// checks if the ComputeRackUnitIdentity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComputeRackUnitIdentity{}

// ComputeRackUnitIdentity The RackUnitIdentity object defines the identity of a rack-mount server under device registration. It abstracts the core attributes needed to manage and monitor rack servers, providing a uniform handle for automation, discovery, and configuration workflows. #### Purpose   A RackUnitIdentity acts as the primary identity anchor for rack servers, enabling inventory collection and synchronization of rack-mount systems, triggering discovery, decommission, and profile-deployment workflows, and providing a consistent reference point for policy application and audit trails. #### Key Concepts   - **Device Registration Linkage:** Associates the rack server to its controlling device registration endpoint.   - **Global Uniqueness:** Combines vendor/model/serial with registration context to avoid identity collisions.   - **Workflow Triggers:** Serves as the input/output reference for discovery and post-discovery actions.   - **Abstraction Layer:** Hides low-level hardware details, exposing a simple identity for configuration tools.
...
// GetDefaultClassId returns the default value "compute.RackUnitIdentity" of the ClassId field.
func (o *ComputeRackUnitIdentity) GetDefaultClassId() interface{} {
	return "compute.RackUnitIdentity"
}
...
// GetDefaultObjectType returns the default value "compute.RackUnitIdentity" of the ObjectType field.
func (o *ComputeRackUnitIdentity) GetDefaultObjectType() interface{} {
	return "compute.RackUnitIdentity"
}
...
func (o *ComputeRackUnitIdentity) GetAdapterSerial() string {
	if o == nil || IsNil(o.AdapterSerial) {
		var ret string
		return ret
	}
...
func (o ComputeRackUnitIdentity) ToMap() (map[string]interface{}, error) {
...
func (o *ComputeRackUnitIdentity) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varComputeRackUnitIdentityWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varComputeRackUnitIdentity)
	if err == nil {
