...
// NiatelemetryAaaRadiusProviderDetailsAllOf Definition of the list of properties defined in 'niatelemetry.AaaRadiusProviderDetails', excluding properties defined in parent classes.
type NiatelemetryAaaRadiusProviderDetailsAllOf struct {
...
type _NiatelemetryAaaRadiusProviderDetailsAllOf NiatelemetryAaaRadiusProviderDetailsAllOf
...
func NewNiatelemetryAaaRadiusProviderDetailsAllOf(classId string, objectType string) *NiatelemetryAaaRadiusProviderDetailsAllOf {
	this := NiatelemetryAaaRadiusProviderDetailsAllOf{}
...
func (o NiatelemetryAaaRadiusProviderDetailsAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetryAaaRadiusProviderDetailsAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetryAaaRadiusProviderDetailsAllOf := _NiatelemetryAaaRadiusProviderDetailsAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetryAaaRadiusProviderDetailsAllOf); err == nil {
		*o = NiatelemetryAaaRadiusProviderDetailsAllOf(varNiatelemetryAaaRadiusProviderDetailsAllOf)
	}
...
type NullableNiatelemetryAaaRadiusProviderDetailsAllOf struct {
	value *NiatelemetryAaaRadiusProviderDetailsAllOf
	isSet bool
}

func (v NullableNiatelemetryAaaRadiusProviderDetailsAllOf) Get() *NiatelemetryAaaRadiusProviderDetailsAllOf {
	return v.value
}

func (v *NullableNiatelemetryAaaRadiusProviderDetailsAllOf) Set(val *NiatelemetryAaaRadiusProviderDetailsAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetryAaaRadiusProviderDetailsAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetryAaaRadiusProviderDetailsAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetryAaaRadiusProviderDetailsAllOf(val *NiatelemetryAaaRadiusProviderDetailsAllOf) *NullableNiatelemetryAaaRadiusProviderDetailsAllOf {
	return &NullableNiatelemetryAaaRadiusProviderDetailsAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetryAaaRadiusProviderDetailsAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetryAaaRadiusProviderDetailsAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
