...
// checks if the TelemetryDruidBasePostAggregator type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TelemetryDruidBasePostAggregator{}
...
func (o TelemetryDruidBasePostAggregator) ToMap() (map[string]interface{}, error) {
...
func (o *TelemetryDruidBasePostAggregator) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTelemetryDruidBasePostAggregator)
