...
// GetDefaultClassId returns the default value "workflow.DecisionTask" of the ClassId field.
func (o *WorkflowDecisionTask) GetDefaultClassId() interface{} {
	return "workflow.DecisionTask"
}
...
// GetDefaultObjectType returns the default value "workflow.DecisionTask" of the ObjectType field.
func (o *WorkflowDecisionTask) GetDefaultObjectType() interface{} {
	return "workflow.DecisionTask"
}
...
func (o *WorkflowDecisionTask) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varWorkflowDecisionTask.ObjectType = varWorkflowDecisionTaskWithoutEmbeddedStruct.ObjectType
