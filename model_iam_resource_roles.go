...
// IamResourceRoles ResourceRoles maps roles to a specific resource (e.g., an organization) within a permission, shaping the effective access model. #### Purpose It provides fine-grained control over which roles apply to which resources for a given permission. #### Key Concepts - **Resource-scoped Roles:** Tailors access at the resource boundary. - **Role Composition:** Works with roles, privilege sets, and endpoint roles. - **Permission-centric:** Operates within a permission’s assignment context. - **Flexible Governance:** Enables nuanced, resource-level authorization design.
