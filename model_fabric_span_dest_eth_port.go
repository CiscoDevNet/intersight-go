...
type FabricSpanDestEthPort struct {
	...
	// Forward error correction setting of the SPAN Destination Port. * `Auto` - Forward error correction option 'Auto'. * `Cl91` - Forward error correction option 'cl91'. * `Cl74` - Forward error correction option 'cl74'. * `rs-cons16` - Forward Error Correction option \"rs-cons16\". * `rs-ieee` - Forward Error Correction option \"rs-ieee\". * `Off` - Turn off Forward Error Correction.
