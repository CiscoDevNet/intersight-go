...
// checks if the AssetOrchestrationHitachiVirtualStoragePlatformOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetOrchestrationHitachiVirtualStoragePlatformOptions{}
...
// GetDefaultClassId returns the default value "asset.OrchestrationHitachiVirtualStoragePlatformOptions" of the ClassId field.
func (o *AssetOrchestrationHitachiVirtualStoragePlatformOptions) GetDefaultClassId() interface{} {
	return "asset.OrchestrationHitachiVirtualStoragePlatformOptions"
}
...
// GetDefaultObjectType returns the default value "asset.OrchestrationHitachiVirtualStoragePlatformOptions" of the ObjectType field.
func (o *AssetOrchestrationHitachiVirtualStoragePlatformOptions) GetDefaultObjectType() interface{} {
	return "asset.OrchestrationHitachiVirtualStoragePlatformOptions"
}
...
func (o *AssetOrchestrationHitachiVirtualStoragePlatformOptions) GetOpsCenterManagementAddress() string {
	if o == nil || IsNil(o.OpsCenterManagementAddress) {
		var ret string
		return ret
	}
...
func (o AssetOrchestrationHitachiVirtualStoragePlatformOptions) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OpsCenterManagementAddress) {
...
func (o *AssetOrchestrationHitachiVirtualStoragePlatformOptions) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAssetOrchestrationHitachiVirtualStoragePlatformOptionsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAssetOrchestrationHitachiVirtualStoragePlatformOptions)
	if err == nil {
