...
// checks if the IaasDiagnosticMessagesList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IaasDiagnosticMessagesList{}
...
func NewIaasDiagnosticMessagesList(objectType string) *IaasDiagnosticMessagesList {
...
func (o IaasDiagnosticMessagesList) ToMap() (map[string]interface{}, error) {
...
func (o *IaasDiagnosticMessagesList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIaasDiagnosticMessagesListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varIaasDiagnosticMessagesList)
	if err == nil {
