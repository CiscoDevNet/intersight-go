...
type ApiCreateTaskPureFlashBladeScopedInventoryRequest struct {
	ctx                               context.Context
	ApiService                        *TaskApiService
	taskPureFlashBladeScopedInventory *TaskPureFlashBladeScopedInventory
	ifMatch                           *string
	ifNoneMatch                       *string
}

// The &#39;task.PureFlashBladeScopedInventory&#39; resource to create.
func (r ApiCreateTaskPureFlashBladeScopedInventoryRequest) TaskPureFlashBladeScopedInventory(taskPureFlashBladeScopedInventory TaskPureFlashBladeScopedInventory) ApiCreateTaskPureFlashBladeScopedInventoryRequest {
	r.taskPureFlashBladeScopedInventory = &taskPureFlashBladeScopedInventory
	return r
}

// For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
func (r ApiCreateTaskPureFlashBladeScopedInventoryRequest) IfMatch(ifMatch string) ApiCreateTaskPureFlashBladeScopedInventoryRequest {
	r.ifMatch = &ifMatch
	return r
}

// For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn&#39;t happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource&#39;s ETag doesn&#39;t match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don&#39;t have to be identical byte for byte.
func (r ApiCreateTaskPureFlashBladeScopedInventoryRequest) IfNoneMatch(ifNoneMatch string) ApiCreateTaskPureFlashBladeScopedInventoryRequest {
	r.ifNoneMatch = &ifNoneMatch
	return r
}

func (r ApiCreateTaskPureFlashBladeScopedInventoryRequest) Execute() (*TaskPureFlashBladeScopedInventory, *http.Response, error) {
	return r.ApiService.CreateTaskPureFlashBladeScopedInventoryExecute(r)
}

/*
CreateTaskPureFlashBladeScopedInventory Create a 'task.PureFlashBladeScopedInventory' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiCreateTaskPureFlashBladeScopedInventoryRequest
*/
func (a *TaskApiService) CreateTaskPureFlashBladeScopedInventory(ctx context.Context) ApiCreateTaskPureFlashBladeScopedInventoryRequest {
	return ApiCreateTaskPureFlashBladeScopedInventoryRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return TaskPureFlashBladeScopedInventory
func (a *TaskApiService) CreateTaskPureFlashBladeScopedInventoryExecute(r ApiCreateTaskPureFlashBladeScopedInventoryRequest) (*TaskPureFlashBladeScopedInventory, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *TaskPureFlashBladeScopedInventory
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TaskApiService.CreateTaskPureFlashBladeScopedInventory")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/task/PureFlashBladeScopedInventories"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.taskPureFlashBladeScopedInventory == nil {
		return localVarReturnValue, nil, reportError("taskPureFlashBladeScopedInventory is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.taskPureFlashBladeScopedInventory
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
