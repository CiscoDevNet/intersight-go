...
// checks if the NiaapiNibFileDownloader type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiaapiNibFileDownloader{}

// NiaapiNibFileDownloader The NibFileDownloader object is central to file management, offering presigned URLs for downloading metadata files from servers. It supports secure and efficient data retrieval. #### Purpose NibFileDownloader provides presigned URLs for metadata file downloads, ensuring users have reliable access to necessary data for their systems. #### Key Concepts - **Secure Retrieval:** Offers presigned URLs for safe and efficient metadata file downloads. - **Data Accessibility:** Facilitates quick and reliable access to metadata files, supporting user needs. - **System Integration:** Ensures compatibility with systems for efficient file management and download.
...
// GetDefaultClassId returns the default value "niaapi.NibFileDownloader" of the ClassId field.
func (o *NiaapiNibFileDownloader) GetDefaultClassId() interface{} {
	return "niaapi.NibFileDownloader"
}
...
// GetDefaultObjectType returns the default value "niaapi.NibFileDownloader" of the ObjectType field.
func (o *NiaapiNibFileDownloader) GetDefaultObjectType() interface{} {
	return "niaapi.NibFileDownloader"
}
...
func (o NiaapiNibFileDownloader) ToMap() (map[string]interface{}, error) {
...
func (o *NiaapiNibFileDownloader) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiaapiNibFileDownloaderWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiaapiNibFileDownloader)
	if err == nil {
