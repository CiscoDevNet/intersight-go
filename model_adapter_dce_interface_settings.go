...
// checks if the AdapterDceInterfaceSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdapterDceInterfaceSettings{}
...
// GetDefaultClassId returns the default value "adapter.DceInterfaceSettings" of the ClassId field.
func (o *AdapterDceInterfaceSettings) GetDefaultClassId() interface{} {
	return "adapter.DceInterfaceSettings"
}
...
// GetDefaultObjectType returns the default value "adapter.DceInterfaceSettings" of the ObjectType field.
func (o *AdapterDceInterfaceSettings) GetDefaultObjectType() interface{} {
	return "adapter.DceInterfaceSettings"
}
...
func (o AdapterDceInterfaceSettings) ToMap() (map[string]interface{}, error) {
...
func (o *AdapterDceInterfaceSettings) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAdapterDceInterfaceSettingsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAdapterDceInterfaceSettings)
	if err == nil {
