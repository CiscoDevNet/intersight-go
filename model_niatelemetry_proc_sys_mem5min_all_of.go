...
// NiatelemetryProcSysMem5minAllOf Definition of the list of properties defined in 'niatelemetry.ProcSysMem5min', excluding properties defined in parent classes.
type NiatelemetryProcSysMem5minAllOf struct {
...
type _NiatelemetryProcSysMem5minAllOf NiatelemetryProcSysMem5minAllOf
...
func NewNiatelemetryProcSysMem5minAllOf(classId string, objectType string) *NiatelemetryProcSysMem5minAllOf {
	this := NiatelemetryProcSysMem5minAllOf{}
...
func (o NiatelemetryProcSysMem5minAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetryProcSysMem5minAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetryProcSysMem5minAllOf := _NiatelemetryProcSysMem5minAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetryProcSysMem5minAllOf); err == nil {
		*o = NiatelemetryProcSysMem5minAllOf(varNiatelemetryProcSysMem5minAllOf)
	}
...
type NullableNiatelemetryProcSysMem5minAllOf struct {
	value *NiatelemetryProcSysMem5minAllOf
	isSet bool
}

func (v NullableNiatelemetryProcSysMem5minAllOf) Get() *NiatelemetryProcSysMem5minAllOf {
	return v.value
}

func (v *NullableNiatelemetryProcSysMem5minAllOf) Set(val *NiatelemetryProcSysMem5minAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetryProcSysMem5minAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetryProcSysMem5minAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetryProcSysMem5minAllOf(val *NiatelemetryProcSysMem5minAllOf) *NullableNiatelemetryProcSysMem5minAllOf {
	return &NullableNiatelemetryProcSysMem5minAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetryProcSysMem5minAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetryProcSysMem5minAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
