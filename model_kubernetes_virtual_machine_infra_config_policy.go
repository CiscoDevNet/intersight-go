...
// checks if the KubernetesVirtualMachineInfraConfigPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesVirtualMachineInfraConfigPolicy{}
...
// GetDefaultClassId returns the default value "kubernetes.VirtualMachineInfraConfigPolicy" of the ClassId field.
func (o *KubernetesVirtualMachineInfraConfigPolicy) GetDefaultClassId() interface{} {
	return "kubernetes.VirtualMachineInfraConfigPolicy"
}
...
// GetDefaultObjectType returns the default value "kubernetes.VirtualMachineInfraConfigPolicy" of the ObjectType field.
func (o *KubernetesVirtualMachineInfraConfigPolicy) GetDefaultObjectType() interface{} {
	return "kubernetes.VirtualMachineInfraConfigPolicy"
}
...
func (o *KubernetesVirtualMachineInfraConfigPolicy) SetOrganizationNil() {
...
func (o *KubernetesVirtualMachineInfraConfigPolicy) SetTargetNil() {
	o.Target.Set(nil)
}
...
func (o KubernetesVirtualMachineInfraConfigPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *KubernetesVirtualMachineInfraConfigPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varKubernetesVirtualMachineInfraConfigPolicyWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varKubernetesVirtualMachineInfraConfigPolicy)
	if err == nil {
