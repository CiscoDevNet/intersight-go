...
type MarketplaceUseCase struct {
	...
	Catalog              NullableMarketplaceCatalogRelationship `json:"Catalog,omitempty"`
...
func (o *MarketplaceUseCase) GetCatalog() MarketplaceCatalogRelationship {
	if o == nil || IsNil(o.Catalog.Get()) {
		var ret MarketplaceCatalogRelationship
		return ret
	}
...
// SetCatalog gets a reference to the given NullableMarketplaceCatalogRelationship and assigns it to the Catalog field.
