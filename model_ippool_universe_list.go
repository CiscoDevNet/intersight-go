...
// checks if the IppoolUniverseList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IppoolUniverseList{}
...
func (o IppoolUniverseList) ToMap() (map[string]interface{}, error) {
...
func (o *IppoolUniverseList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIppoolUniverseListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varIppoolUniverseList)
	if err == nil {
